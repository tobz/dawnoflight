...
using log4net;
	...
	GameNPC[] npcs;
		...
		QuestBuilder builder = QuestMgr.getBuilder(typeof(maulerinvasion));
			...
			a.AddRequirement(eRequirementType.QuestGivable,typeof(maulerinvasion),VikingKreimhilde);
			a.AddRequirement(eRequirementType.QuestPending,typeof(maulerinvasion),null,(eComparator)5);
        ...
        AddBehaviour(a);
			...
			a.AddRequirement(eRequirementType.QuestGivable,typeof(maulerinvasion),VikingKreimhilde);
			a.AddRequirement(eRequirementType.QuestPending,typeof(maulerinvasion),null,(eComparator)5);
            a.AddAction(eActionType.OfferQuest, typeof(maulerinvasion), LanguageMgr.GetTranslation(ServerProperties.Properties.SERV_LANGUAGE, "Mid.MaulerInvasion.OfferQuest"));
			AddBehaviour(a);
			a = builder.CreateBehaviour(VikingKreimhilde,-1);
				a.AddTrigger(eTriggerType.DeclineQuest,null,typeof(maulerinvasion));
        ...
        AddBehaviour(a);
			a = builder.CreateBehaviour(VikingKreimhilde,-1);
				a.AddTrigger(eTriggerType.AcceptQuest,null,typeof(maulerinvasion));
			a.AddAction(eActionType.GiveQuest,typeof(maulerinvasion),VikingKreimhilde);
        ...
        AddBehaviour(a);
			...
			a.AddRequirement(eRequirementType.QuestStep,typeof(maulerinvasion),3,(eComparator)1);
			a.AddAction(eActionType.GiveItem,blackmaulercubpelt,null);
			a.AddAction(eActionType.IncQuestStep,typeof(maulerinvasion),null);
			AddBehaviour(a);
			a = builder.CreateBehaviour(VikingKreimhilde,-1);
				a.AddTrigger(eTriggerType.Interact,null,VikingKreimhilde);
			a.AddRequirement(eRequirementType.QuestStep,typeof(maulerinvasion),3,(eComparator)3);
        ...
        a.AddAction(eActionType.SetQuestStep,typeof(maulerinvasion),4);
			...
			a.AddRequirement(eRequirementType.QuestStep,typeof(maulerinvasion),4,(eComparator)3);
        ...
        a.AddAction(eActionType.SetQuestStep,typeof(maulerinvasion),5);
			a.AddAction(eActionType.TakeItem,blackmaulercubpelt,null);
			AddBehaviour(a);
			a = builder.CreateBehaviour(VikingKreimhilde,-1);
				a.AddTrigger(eTriggerType.GiveItem,VikingKreimhilde,blackmaulercubpelt);
			a.AddRequirement(eRequirementType.QuestStep,typeof(maulerinvasion),5,(eComparator)3);
        ...
        a.AddAction(eActionType.GiveXP,5,null);
			...
			a.AddAction(eActionType.FinishQuest,typeof(maulerinvasion),null);
			a.AddAction(eActionType.TakeItem,blackmaulercubpelt,null);
			AddBehaviour(a);
			a = builder.CreateBehaviour(VikingKreimhilde,-1);
				a.AddTrigger(eTriggerType.GiveItem,VikingKreimhilde,blackmaulercubpelt);
