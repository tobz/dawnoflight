...
namespace DawnOfLight.GameServer.Effects
{
	...
	public class ProtectEffect : StaticEffect, IGameEffect
	{
		...
		public void Start(GamePlayer protectSource, GamePlayer protectTarget)
		{
			...
			{
				protectSource.Out.SendMessage(LanguageMgr.GetTranslation(protectSource.Client, "Effects.ProtectEffect.YouProtectingYBut", protectTarget.GetName(0, false)), ChatType.CT_System, ChatLocation.CL_SystemWindow);
				protectTarget.Out.SendMessage(LanguageMgr.GetTranslation(protectTarget.Client, "Effects.ProtectEffect.XProtectingYouBut", protectSource.GetName(0, true)), ChatType.CT_System, ChatLocation.CL_SystemWindow);
			}
			else
			{
				protectSource.Out.SendMessage(LanguageMgr.GetTranslation(protectSource.Client, "Effects.ProtectEffect.YouProtectingY", protectTarget.GetName(0, false)), ChatType.CT_System, ChatLocation.CL_SystemWindow);
				protectTarget.Out.SendMessage(LanguageMgr.GetTranslation(protectTarget.Client, "Effects.ProtectEffect.XProtectingYou", protectSource.GetName(0, true)), ChatType.CT_System, ChatLocation.CL_SystemWindow);
			}
		}
		...
		public override void Cancel(bool playerCancel)
		{
			...
			m_protectSource.Out.SendMessage(LanguageMgr.GetTranslation(m_protectSource.Client, "Effects.ProtectEffect.YouNoProtectY", m_protectTarget.GetName(0, false)), ChatType.CT_System, ChatLocation.CL_SystemWindow);
			m_protectTarget.Out.SendMessage(LanguageMgr.GetTranslation(m_protectTarget.Client, "Effects.ProtectEffect.XNoProtectYou", m_protectSource.GetName(0, true)), ChatType.CT_System, ChatLocation.CL_SystemWindow);
