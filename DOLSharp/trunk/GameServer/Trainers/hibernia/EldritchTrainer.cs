...
namespace DawnOfLight.GameServer.Trainers.hibernia
{
	...
	public class EldritchTrainer : GameTrainer
	{
		...
		public override bool Interact(GamePlayer player)
		{
			...
			{
				player.Out.SendMessage(this.Name + " says, \"Drink up this knowledge, " + player.Name + ", and remember it, for there shall be a day when I no longer rise in the morning, and you may be required to take my place.\"", ChatType.CT_Say, ChatLocation.CL_ChatWindow);
			}
			else
			{
				...
				{
					player.Out.SendMessage(this.Name + " says, \"Greetings, " + player.Name + ". It is my understanding that you have chosen the Path of Focus, and wish to train as an [Eldritch].\"", ChatType.CT_System, ChatLocation.CL_PopupWindow);
