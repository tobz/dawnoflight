	...
	public class NightshadeTrainer : GameTrainer
	{
		...
		/// <returns></returns>
 		...
 		{		
			...
			{
				player.Out.SendMessage(this.Name + " says, \"Here for a bit of training, " + player.Name + "? Step up and get it!\"", ChatType.CT_System, ChatLocation.CL_PopupWindow); //popup window on live
			} 
			else 
			{
				...
				{
					player.Out.SendMessage(this.Name + " says, \"You have thought this through, I'm sure. Tell me now if you wish to train as a [Nightshade] and follow the Path of Essence.\"", ChatType.CT_System, ChatLocation.CL_PopupWindow);
