...
namespace DawnOfLight.GameServer.Trainers.hibernia
{
	...
	public class ChampionTrainer : GameTrainer
	{
		...
		public override bool Interact(GamePlayer player)
		{
			...
			{
				player.Out.SendMessage(this.Name + " says, \"I'm glad to see you taking an interest in your training, " + player.Name + ". There is always room to grow and learn!\"", ChatType.CT_Say, ChatLocation.CL_ChatWindow);
			}
			else
			{
				...
				{
					player.Out.SendMessage(this.Name + " says, \"Champions follow the Path of Essence. Choose now to become a [Champion], and I will train you in our ways, and the ways of the Path we follow.\"", ChatType.CT_System, ChatLocation.CL_PopupWindow);
