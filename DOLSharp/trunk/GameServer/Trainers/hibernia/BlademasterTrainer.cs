...
namespace DawnOfLight.GameServer.Trainers.hibernia
{
	...
	public class BlademasterTrainer : GameTrainer
	{
		...
		public override bool Interact(GamePlayer player)
		{
			...
			{
				player.Out.SendMessage(this.Name + " says, \"Do you wish to learn some more, " + player.Name + "? Step up and receive your training!\"", ChatType.CT_Say, ChatLocation.CL_ChatWindow);
			}
			else
			{
				...
				{
					player.Out.SendMessage(this.Name + " says, \"" + player.Name + ", do you choose the Path of Harmony, and life as a [Blademaster]?\"", ChatType.CT_System, ChatLocation.CL_PopupWindow);
