	...
	public class MagicianTrainer : GameTrainer
	{
		...
		public override bool Interact(GamePlayer player)
		{
			...
			if (player.CharacterClass.ID == (int) TrainedClass)
			{
				...
				if (player.Level>=5)
				{
					player.Out.SendMessage(this.Name + " says, \"You must now seek your training elsewhere. Which path would you like to follow? [Eldritch], [Enchanter] or [Mentalist]?\"", ChatType.CT_System, ChatLocation.CL_PopupWindow);
				}
				else
				{
				...
				{
					player.Out.SendMessage(this.Name + " says, \"Do you require a [practice staff]?\"", ChatType.CT_System, ChatLocation.CL_PopupWindow);
				}
			...
			switch (text) {
				case "Eldritch":
					if(player.Race == (int) eRace.Elf || player.Race == (int) eRace.Lurikeen){
						...
						player.Out.SendMessage(this.Name + " says, \"The path of a Eldritch is not available to your race. Please choose another.\"", ChatType.CT_System, ChatLocation.CL_PopupWindow);
					}
					return true;
				case "Enchanter":
					if(player.Race == (int) eRace.Elf || player.Race == (int) eRace.Lurikeen){
						...
						player.Out.SendMessage(this.Name + " says, \"The path of a Enchanter is not available to your race. Please choose another.\"", ChatType.CT_System, ChatLocation.CL_PopupWindow);
					}
					return true;
				case "Mentalist":
					...
					{
						player.Out.SendMessage(this.Name + " says, \"The path of a Mentalist is not available to your race. Please choose another.\"", ChatType.CT_System, ChatLocation.CL_PopupWindow);
					}
					return true;
				case "practice staff":
