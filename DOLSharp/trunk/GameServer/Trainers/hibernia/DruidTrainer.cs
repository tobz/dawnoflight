...
namespace DawnOfLight.GameServer.Trainers.hibernia
{
	...
	public class DruidTrainer : GameTrainer
	{
		...
		public override bool Interact(GamePlayer player)
		{
			...
			{
				player.Out.SendMessage(this.Name + " says, \"I shall impart all that I know, young Druid.\"", ChatType.CT_Say, ChatLocation.CL_ChatWindow);
			}
			else
			{
				...
				{
					player.Out.SendMessage(this.Name + " says, \"Do you wish to walk the Path of Harmony and learn the ways of the [Druid]?\"", ChatType.CT_System, ChatLocation.CL_PopupWindow);
