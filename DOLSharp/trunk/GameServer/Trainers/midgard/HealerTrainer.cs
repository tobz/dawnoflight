	...
	public class HealerTrainer : GameTrainer
	{
		...
		public override bool Interact(GamePlayer player)
		{
			...
			else
			{
				...
				{
					player.Out.SendMessage(this.Name + " says, \"Do you desire to [join the House of Eir] and defend our realm as a Healer?\"",ChatType.CT_Say,ChatLocation.CL_PopupWindow);
