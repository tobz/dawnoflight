...
namespace DawnOfLight.GameServer.Trainers.midgard
{
	...
	public class BonedancerTrainer : GameTrainer
	{
		...
		public override bool Interact(GamePlayer player)
		{
			...
			{
				player.Out.SendMessage(LanguageMgr.GetTranslation(player.Client.Account.Language, "BonedancerTrainer.Interact.Text2", this.Name), ChatType.CT_System, ChatLocation.CL_ChatWindow);
			}
			else
			{
				...
				{
					player.Out.SendMessage(LanguageMgr.GetTranslation(player.Client.Account.Language, "BonedancerTrainer.Interact.Text1", this.Name), ChatType.CT_Say, ChatLocation.CL_PopupWindow);
