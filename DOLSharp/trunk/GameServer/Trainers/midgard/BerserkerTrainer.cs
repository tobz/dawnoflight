		...
		/// <returns></returns>
 		...
 		{		
			...
			else
			{
				...
				{
					player.Out.SendMessage(this.Name + " says, \"Do you desire to [join the House of Modi] and defend our realm as a Berserker?\"",ChatType.CT_Say,ChatLocation.CL_PopupWindow);
