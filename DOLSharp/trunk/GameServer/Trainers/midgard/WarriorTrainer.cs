		...
		/// <returns></returns>
 		...
 		{		
			...
			else
			{
				...
				{
					player.Out.SendMessage(this.Name + " says, \"Do you desire to [join the House of Tyr] and defend our realm as a Warrior?\"",ChatType.CT_Say,ChatLocation.CL_PopupWindow);
