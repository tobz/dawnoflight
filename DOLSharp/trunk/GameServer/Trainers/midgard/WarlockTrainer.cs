	...
	public class WarlockTrainer : GameTrainer
	{
		...
		public override bool Interact(GamePlayer player)
		{
			...
			else
			{
				...
				{
					player.Out.SendMessage(this.Name + " says, \"Do you desire to [join the House of Hel] and defend our realm as a Warlock?\"", ChatType.CT_Say, ChatLocation.CL_PopupWindow);
