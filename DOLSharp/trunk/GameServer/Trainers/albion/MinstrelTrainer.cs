		...
		/// <returns></returns>
 		...
 		{		
			...
			else
			{
				...
				{
					player.Out.SendMessage(this.Name + " says, \"Do you desire to [join the Academy] and sing our song throughout Albion as a Minstrel?\"",ChatType.CT_Say,ChatLocation.CL_PopupWindow);
