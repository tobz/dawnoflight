		...
		/// <returns></returns>
 		...
 		{		
			...
			else
			{
				...
				{
					player.Out.SendMessage(this.Name + " says, \"Do you desire to [join the Academy] and summon the power of the elements as a Wizard?\"",ChatType.CT_Say,ChatLocation.CL_PopupWindow);
