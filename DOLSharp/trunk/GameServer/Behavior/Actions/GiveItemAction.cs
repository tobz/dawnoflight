    ...
    {               
        ...
        public override void Perform(DOLEvent e, object sender, EventArgs args)
        {
            ...
            if (Q == null)
            {
                ...
                {
                    player.Out.SendMessage(LanguageMgr.GetTranslation(player.Client.Account.Language, "Behaviour.GiveItemAction.GiveButInventFull", inventoryItem.GetName(0, false)), ChatType.CT_System, ChatLocation.CL_SystemWindow);                    
                }
                else
                {
                    player.Out.SendMessage(LanguageMgr.GetTranslation(player.Client.Account.Language, "Behaviour.GiveItemAction.YouReceiveItem", inventoryItem.GetName(0, false)), ChatType.CT_Loot, ChatLocation.CL_SystemWindow);
