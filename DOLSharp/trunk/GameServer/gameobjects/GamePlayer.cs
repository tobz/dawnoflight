	...
	public class GamePlayer : GameLiving
	{
		...
		protected virtual int QuitTimerCallback(RegionTimer callingTimer)
		{
			...
			if (Client.Account.PrivLevel == 1)
			{
				...
				{
					Out.SendMessage(LanguageMgr.GetTranslation(Client.Account.Language, "GamePlayer.Quit.CantQuitCrafting"), ChatType.CT_Important, ChatLocation.CL_SystemWindow);
					m_quitTimer = null;
					return 0;
				}
				...
				if (secondsleft > 0)
				{
					...
					{
						Out.SendMessage(LanguageMgr.GetTranslation(Client.Account.Language, "GamePlayer.Quit.YouWillQuit1", secondsleft), ChatType.CT_Important, ChatLocation.CL_SystemWindow);
					}
					return 1000;
				}
			}
		...
		public void OnLinkdeath()
		{
			...
			foreach (GamePlayer player in GetPlayersInRadius(WorldMgr.INFO_DISTANCE))
			{
				...
				if (GameServer.ServerRules.IsAllowedToUnderstand(this, player))
					player.Out.SendMessage(LanguageMgr.GetTranslation(player.Client.Account.Language, "GamePlayer.OnLinkdeath.Linkdead", Name), ChatType.CT_Important, ChatLocation.CL_SystemWindow);
			}
		...
		public virtual bool Quit(bool forced)
		{
			if (!forced)
			{
				if (!IsAlive)
				{
					Out.SendMessage(LanguageMgr.GetTranslation(Client.Account.Language, "GamePlayer.Quit.CantQuitDead"), ChatType.CT_System, ChatLocation.CL_SystemWindow);
					return false;
				}
				if (Steed != null || IsOnHorse)
				{
					Out.SendMessage(LanguageMgr.GetTranslation(Client.Account.Language, "GamePlayer.Quit.CantQuitMount"), ChatType.CT_System, ChatLocation.CL_SystemWindow);
					return false;
				}
				if (IsMoving)
				{
					Out.SendMessage(LanguageMgr.GetTranslation(Client.Account.Language, "GamePlayer.Quit.CantQuitStanding"), ChatType.CT_System, ChatLocation.CL_SystemWindow);
					return false;
				}
				if (CraftTimer != null && CraftTimer.IsAlive)
				{
					Out.SendMessage(LanguageMgr.GetTranslation(Client.Account.Language, "GamePlayer.Quit.CantQuitCrafting"), ChatType.CT_System, ChatLocation.CL_SystemWindow);
					return false;
				}

				if (CurrentRegion.IsInstance)
				{
					Out.SendMessage("You cannot quit in an instance!", ChatType.CT_System, ChatLocation.CL_SystemWindow);
					return false;
				}
				...
				if (Statistics != null)
				{
					...
					if (stats != "")
					{
						Out.SendMessage(stats, ChatType.CT_System, ChatLocation.CL_SystemWindow);
					}
				}
				...
				if (secondsleft > 20)
					Out.SendMessage(LanguageMgr.GetTranslation(Client.Account.Language, "GamePlayer.Quit.RecentlyInCombat"), ChatType.CT_System, ChatLocation.CL_SystemWindow);
				Out.SendMessage(LanguageMgr.GetTranslation(Client.Account.Language, "GamePlayer.Quit.YouWillQuit2", secondsleft), ChatType.CT_System, ChatLocation.CL_SystemWindow);
			}
			else
			{
				//Notify our event handlers (if any)
		...
		public virtual void Bind(bool forced)
		{
			...
			if (CurrentRegion.IsInstance)
			{
				Out.SendMessage(LanguageMgr.GetTranslation(Client.Account.Language, "GamePlayer.Bind.CantHere"), ChatType.CT_System, ChatLocation.CL_SystemWindow);
				return;
			}
			...
			Out.SendMessage(LanguageMgr.GetTranslation(Client.Account.Language, "GamePlayer.Bind.LastBindPoint", description), ChatType.CT_System, ChatLocation.CL_SystemWindow);

			if (!IsAlive)
			{
				Out.SendMessage(LanguageMgr.GetTranslation(Client.Account.Language, "GamePlayer.Bind.CantBindDead"), ChatType.CT_System, ChatLocation.CL_SystemWindow);
				return;
			}
			...
			{
				Out.SendMessage(LanguageMgr.GetTranslation(Client.Account.Language, "GamePlayer.Bind.MustWait", (1 + (60000 - changeTime) / 1000)), ChatType.CT_System, ChatLocation.CL_SystemWindow);
				return;
			}
			bool bound = false;
			...
			if (bound)
			{
				...
				Out.SendMessage(LanguageMgr.GetTranslation(Client.Account.Language, "GamePlayer.Bind.Bound"), ChatType.CT_System, ChatLocation.CL_SystemWindow);
			}
			else
				Out.SendMessage(LanguageMgr.GetTranslation(Client.Account.Language, "GamePlayer.Bind.CantHere"), ChatType.CT_System, ChatLocation.CL_SystemWindow);
		}
		...
		public virtual void Release(eReleaseType releaseCommand, bool forced)
		{
			...
			{
				Out.SendMessage(LanguageMgr.GetTranslation(Client.Account.Language, "GamePlayer.Release.NoValidBindpoint"), ChatType.CT_System, ChatLocation.CL_SystemWindow);
			...
			if (IsAlive)
			{
				Out.SendMessage(LanguageMgr.GetTranslation(Client.Account.Language, "GamePlayer.Release.NotDead"), ChatType.CT_System, ChatLocation.CL_SystemWindow);
				return;
			}
			...
			if (!forced)
			{
				...
				{
					Out.SendMessage(LanguageMgr.GetTranslation(Client.Account.Language, "GamePlayer.Release.CantReleaseDuel"), ChatType.CT_System, ChatLocation.CL_SystemWindow);
					return;
				}
				...
				if (diff >= 1000)
				{
					if (m_automaticRelease)
					{
						...
						Out.SendMessage(LanguageMgr.GetTranslation(Client.Account.Language, "GamePlayer.Release.NoLongerReleaseAuto", diff / 1000), ChatType.CT_System, ChatLocation.CL_SystemWindow);
						return;
					}
					...
					switch (releaseCommand)
					{
						default:
							{
								Out.SendMessage(LanguageMgr.GetTranslation(Client.Account.Language, "GamePlayer.Release.WillReleaseAuto", diff / 1000), ChatType.CT_System, ChatLocation.CL_SystemWindow);
								return;
							}
						case eReleaseType.City:
							{
								Out.SendMessage(LanguageMgr.GetTranslation(Client.Account.Language, "GamePlayer.Release.WillReleaseAutoCity", diff / 1000), ChatType.CT_System, ChatLocation.CL_SystemWindow);
								return;
							}
						case eReleaseType.RvR:
							{
								Out.SendMessage(LanguageMgr.GetTranslation(Client.Account.Language, "GamePlayer.Release.ReleaseToPortalKeep", diff / 1000), ChatType.CT_System, ChatLocation.CL_SystemWindow);
								return;
							}
						case eReleaseType.House:
							{
								Out.SendMessage(LanguageMgr.GetTranslation(Client.Account.Language, "GamePlayer.Release.ReleaseToHouse", diff / 1000), ChatType.CT_System, ChatLocation.CL_SystemWindow);
								return;
							}
					}
				}
			...
			Out.SendMessage(LanguageMgr.GetTranslation(Client.Account.Language, "GamePlayer.Release.YouRelease"), ChatType.CT_YouDied, ChatLocation.CL_SystemWindow);
			Out.SendCloseTimerWindow();
			if (m_releaseTimer != null)
			{
				m_releaseTimer.Stop();
			...
			if (Realm != eRealm.None)
			{
				if (Level > 5)
				{
					...
					if (lostExp > 0)
					{
						...
						Out.SendMessage(LanguageMgr.GetTranslation(Client.Account.Language, "GamePlayer.Release.GraveErected"), ChatType.CT_YouDied, ChatLocation.CL_SystemWindow);
						Out.SendMessage(LanguageMgr.GetTranslation(Client.Account.Language, "GamePlayer.Release.ReturnToPray"), ChatType.CT_YouDied, ChatLocation.CL_SystemWindow);
					}
				}
			}
			...
			if (Level > 10)
			{
				...
				if (deathConLoss > 0)
				{
					...
					Out.SendMessage(LanguageMgr.GetTranslation(Client.Account.Language, "GamePlayer.Release.LostConstitution"), ChatType.CT_YouDied, ChatLocation.CL_SystemWindow);
				}
			}
			...
			{
				Out.SendMessage(LanguageMgr.GetTranslation(Client.Account.Language, "GamePlayer.Release.SurroundingChange"), ChatType.CT_YouDied, ChatLocation.CL_SystemWindow);
			}
			else
			{
				Out.SendMessage(LanguageMgr.GetTranslation(Client.Account.Language, "GamePlayer.Release.NoValidBindpoint"), ChatType.CT_Important, ChatLocation.CL_SystemWindow);
				Bind(true);
			}
		...
		protected virtual int ReleaseTimerCallback(RegionTimer callingTimer)
		{
			...
			{
				Out.SendMessage(LanguageMgr.GetTranslation(Client.Account.Language, "GamePlayer.Release.WillReleaseIn", 10), ChatType.CT_System, ChatLocation.CL_SystemWindow);
				m_releasePhase = 2;
			}
			if (m_releasePhase == 0 && diffToRelease <= 30 && diffToRelease >= 28)
			{
				Out.SendMessage(LanguageMgr.GetTranslation(Client.Account.Language, "GamePlayer.Release.WillReleaseIn", 30), ChatType.CT_System, ChatLocation.CL_SystemWindow);
				m_releasePhase = 1;
			}
			return 1000;
		}
		...
		public virtual void Pray()
		{
			if (!IsAlive)
			{
				Out.SendMessage(LanguageMgr.GetTranslation(Client.Account.Language, "GamePlayer.Pray.CantPrayNow"), ChatType.CT_System, ChatLocation.CL_SystemWindow);
				return;
			}

			if (IsRiding)
			{
				Out.SendMessage("You can't pray while riding a horse!", ChatType.CT_System, ChatLocation.CL_SystemWindow);
				return;
			}
			...
			if (gravestone == null)
			{
				Out.SendMessage(LanguageMgr.GetTranslation(Client.Account.Language, "GamePlayer.Pray.NeedTarget"), ChatType.CT_System, ChatLocation.CL_SystemWindow);
				return;
			}
			if (!gravestone.InternalID.Equals(InternalID))
			{
				Out.SendMessage(LanguageMgr.GetTranslation(Client.Account.Language, "GamePlayer.Pray.SelectGrave"), ChatType.CT_System, ChatLocation.CL_SystemWindow);
				return;
			}
			if (!this.IsWithinRadius(gravestone, 2000))
			{
				Out.SendMessage(LanguageMgr.GetTranslation(Client.Account.Language, "GamePlayer.Pray.MustGetCloser"), ChatType.CT_System, ChatLocation.CL_SystemWindow);
				return;
			}
			if (IsMoving)
			{
				Out.SendMessage(LanguageMgr.GetTranslation(Client.Account.Language, "GamePlayer.Pray.MustStandingStill"), ChatType.CT_System, ChatLocation.CL_SystemWindow);
				return;
			}

			if (IsPraying)
			{
				Out.SendMessage(LanguageMgr.GetTranslation(Client.Account.Language, "GamePlayer.Pray.AlreadyPraying"), ChatType.CT_System, ChatLocation.CL_SystemWindow);
				return;
			}
			...
			Sit(true);
			Out.SendMessage(LanguageMgr.GetTranslation(Client.Account.Language, "GamePlayer.Pray.Begin"), ChatType.CT_System, ChatLocation.CL_SystemWindow);
		...
		protected class PrayAction : RegionAction
		{
			...
			protected override void OnTick()
			{
				...
				if (xp > 0)
				{
					player.Out.SendMessage(LanguageMgr.GetTranslation(player.Client.Account.Language, "GamePlayer.Pray.GainBack"), ChatType.CT_Important, ChatLocation.CL_SystemWindow);
		...
		public virtual void AddSpecialization(Specialization skill)
		{
			...
			if (!m_specialization.TryGetValue(skill.KeyName, out oldskill))
			{
				...
				Out.SendMessage(LanguageMgr.GetTranslation(Client.Account.Language, "GamePlayer.AddSpecialisation.YouLearn", skill.Name), ChatType.CT_System, ChatLocation.CL_SystemWindow);
			}
			else
			{
		...
		public virtual bool RemoveSpecialization(string specKeyName)
		{
			...
			Out.SendMessage(LanguageMgr.GetTranslation(Client.Account.Language, "GamePlayer.RemoveSpecialization.YouLose", playerSpec), ChatType.CT_System, ChatLocation.CL_SystemWindow);
			return true;
		}
		...
		protected virtual bool RemoveSpellLine(SpellLine line)
		{
			...
			Out.SendMessage(LanguageMgr.GetTranslation(Client.Account.Language, "GamePlayer.RemoveSpellLine.YouLose", line.Name), ChatType.CT_System, ChatLocation.CL_SystemWindow);
			return true;
		}
		...
		public override int CalculateLeftHandSwingCount()
		{
			...
			InventoryItem leftWeapon = (Inventory == null) ? null : Inventory.GetItem(InventorySlot.LeftHandWeapon);
		...
		public virtual void AddSpellLine(SpellLine line)
		{
			...
			if (oldline == null)
			{
				...
				Out.SendMessage(LanguageMgr.GetTranslation(Client.Account.Language, "GamePlayer.AddSpellLine.YouLearn", line.Name), ChatType.CT_System, ChatLocation.CL_SystemWindow);
			}
			else
			{
		...
		public virtual void RefreshSpecDependantSkills(bool sendMessages)
		{
			...
			if (sendMessages)
			{
				...
				{
					Out.SendMessage(LanguageMgr.GetTranslation(Client.Account.Language, "GamePlayer.RefreshSpec.YouLearn", style.Name), ChatType.CT_System, ChatLocation.CL_SystemWindow);
					...
					if (message != null)
						Out.SendMessage(message, ChatType.CT_System, ChatLocation.CL_SystemWindow);
				}
			}
		}
					...
					else
					{
						...
						if (newSpec > 0)
						{
							if (sendMessages && line.Level < newSpec)
								Out.SendMessage(LanguageMgr.GetTranslation(Client.Account.Language, "GamePlayer.UpdateSpellLine.GainPower", line.Name), ChatType.CT_System, ChatLocation.CL_SystemWindow);
							line.Level = newSpec;
						}
					}
				}
		...
		{
			Out.SendMessage(LanguageMgr.GetTranslation(Client.Account.Language, "GamePlayer.OnSkillTrained.YouSpend", skill.Level, skill.Name), ChatType.CT_System, ChatLocation.CL_SystemWindow);
			Out.SendMessage(LanguageMgr.GetTranslation(Client.Account.Language, "GamePlayer.OnSkillTrained.YouHave", SkillSpecialtyPoints), ChatType.CT_System, ChatLocation.CL_SystemWindow);
			Message.SystemToOthers(this, LanguageMgr.GetTranslation(Client.Account.Language, "GamePlayer.OnSkillTrained.TrainsInVarious", GetName(0, true)), ChatType.CT_System);
		...
		public virtual void GainRealmPoints(long amount, bool modify, bool sendMessage, bool notify)
		{
			...
			if (sendMessage == true && amount > 0)
				Out.SendMessage(LanguageMgr.GetTranslation(Client.Account.Language, "GamePlayer.GainRealmPoints.YouGet", amount.ToString()), ChatType.CT_Important, ChatLocation.CL_SystemWindow);
			...
			while (RealmPoints >= CalculateRPsFromRealmLevel(RealmLevel + 1) && RealmLevel < ( REALMPOINTS_FOR_LEVEL.Length - 1 ) )
			{
				...
				Out.SendUpdatePlayer();
				Out.SendMessage(LanguageMgr.GetTranslation(Client.Account.Language, "GamePlayer.GainRealmPoints.GainedLevel"), ChatType.CT_System, ChatLocation.CL_SystemWindow);
				if (RealmLevel % 10 == 0)
				{
					Out.SendUpdatePlayerSkills();
					Out.SendMessage(LanguageMgr.GetTranslation(Client.Account.Language, "GamePlayer.GainRealmPoints.GainedRank"), ChatType.CT_System, ChatLocation.CL_SystemWindow);
					Out.SendMessage(LanguageMgr.GetTranslation(Client.Account.Language, "GamePlayer.GainRealmPoints.ReachedRank", (RealmLevel / 10) + 1), ChatType.CT_ScreenCenter, ChatLocation.CL_SystemWindow);
					Out.SendMessage(LanguageMgr.GetTranslation(Client.Account.Language, "GamePlayer.GainRealmPoints.NewRealmTitle", RealmRankTitle(Client.Account.Language)), ChatType.CT_System, ChatLocation.CL_SystemWindow);
					Out.SendMessage(LanguageMgr.GetTranslation(Client.Account.Language, "GamePlayer.GainRealmPoints.GainBonus", RealmLevel / 10), ChatType.CT_System, ChatLocation.CL_SystemWindow);
		...
		{
			return RemoveBountyPoints(amount, str, ChatType.CT_Say, ChatLocation.CL_SystemWindow);
		}
		/// <summary>
		/// Called when this living buy something with realm points
		/// </summary>
		...
		public virtual bool RemoveBountyPoints(long amount, string str, ChatType type, ChatLocation loc)
		{
		...
		public virtual void GainBountyPoints(long amount, bool modify, bool sendMessage, bool notify)
		{
			...
			if(sendMessage == true)
				Out.SendMessage(LanguageMgr.GetTranslation(Client.Account.Language, "GamePlayer.GainBountyPoints.YouGet", amount.ToString()), ChatType.CT_Important, ChatLocation.CL_SystemWindow);
		...
		public override void GainExperience(eXPSource xpSource, long expTotal, long expCampBonus, long expGroupBonus, long expOutpostBonus, bool sendMessage, bool allowMultiply, bool notify)
		{
			...
			if (sendMessage && expTotal > 0)
			{
				...
				Out.SendMessage(LanguageMgr.GetTranslation(Client.Account.Language, "GamePlayer.GainExperience.YouGet", totalExpStr) + expCampBonusStr + expGroupBonusStr, ChatType.CT_Important, ChatLocation.CL_SystemWindow);
			}
			...
			if (expTotal >= 0)
			{
				...
				if (Level >= 5 && CharacterClass.BaseName == CharacterClass.Name)
				{
					if (expTotal > 0)
					{
						Out.SendMessage(LanguageMgr.GetTranslation(Client.Account.Language, "GamePlayer.GainExperience.CannotRaise"), ChatType.CT_Important, ChatLocation.CL_SystemWindow);
						Out.SendMessage(LanguageMgr.GetTranslation(Client.Account.Language, "GamePlayer.GainExperience.TalkToTrainer"), ChatType.CT_Important, ChatLocation.CL_SystemWindow);
					}
				}
		...
		public virtual void OnLevelUp(int previouslevel)
		{
			...
			Out.SendMessage(LanguageMgr.GetTranslation(Client.Account.Language, "GamePlayer.OnLevelUp.YouRaise", Level), ChatType.CT_Important, ChatLocation.CL_SystemWindow);
			Out.SendMessage(LanguageMgr.GetTranslation(Client.Account.Language, "GamePlayer.OnLevelUp.YouAchieved", Level), ChatType.CT_ScreenCenter, ChatLocation.CL_SystemWindow);
			...
			foreach (string str in ServerProperties.Properties.GIVE_DOL_RESPEC_AT_LEVEL.SplitCSV(true))
			{
				...
				if (Level == level_respec)
				{
					...
					{
						Out.SendMessage("As you reached level " + Level + ", you are awarded a DOL (full) respec!", ChatType.CT_Important, ChatLocation.CL_SystemWindow);
					}
				}
			}
			...
			if (statsChanged)
			{
				Out.SendMessage(LanguageMgr.GetTranslation(Client.Account.Language, "GamePlayer.OnLevelUp.StatRaise"), ChatType.CT_Important, ChatLocation.CL_SystemWindow);
			}
			...
			if (CharacterClass.GetTitle(this, previouslevel) != currenttitle)
			{
				...
				Out.SendMessage(LanguageMgr.GetTranslation(Client.Account.Language, "GamePlayer.OnLevelUp.AttainedRank", currenttitle), ChatType.CT_Important, ChatLocation.CL_SystemWindow);
			}
			...
			if (specpoints > 0)
			{
				Out.SendMessage(LanguageMgr.GetTranslation(Client.Account.Language, "GamePlayer.OnLevelUp.YouGetSpec", specpoints), ChatType.CT_Important, ChatLocation.CL_SystemWindow);
			}
			...
			{
				Out.SendMessage(LanguageMgr.GetTranslation(Client.Account.Language, "GamePlayer.OnLevelUp.HitsRaise", (newhp - oldhp)), ChatType.CT_Important, ChatLocation.CL_SystemWindow);
			}
			...
			if (CharacterClass.ManaStat != eStat.UNDEFINED)
			{
				...
				{
					Out.SendMessage(LanguageMgr.GetTranslation(Client.Account.Language, "GamePlayer.OnLevelUp.PowerRaise", (newpow - oldpow)), ChatType.CT_Important, ChatLocation.CL_SystemWindow);
				}
			}
		...
		public virtual void OnLevelSecondStage()
		{
			...
			Out.SendMessage(LanguageMgr.GetTranslation(Client.Account.Language, "GamePlayer.OnLevelUp.SecondStage", Level), ChatType.CT_Important, ChatLocation.CL_SystemWindow);
		...
		protected override Style GetStyleToUse()
		{
			...
			if (NextCombatStyle.WeaponTypeRequirement == (int)eObjectType.Shield)
				weapon = Inventory.GetItem(InventorySlot.LeftHandWeapon);
		...
		public override bool IsCloakHoodUp
		{
			...
			set
			{
				...
				if (value)
				{
					Out.SendMessage(LanguageMgr.GetTranslation(Client.Account.Language, "GamePlayer.IsCloakHoodUp.NowWear"), ChatType.CT_System, ChatLocation.CL_SystemWindow);
				}
				else
				{
					Out.SendMessage(LanguageMgr.GetTranslation(Client.Account.Language, "GamePlayer.IsCloakHoodUp.NoLongerWear"), ChatType.CT_System, ChatLocation.CL_SystemWindow);
				}
			}
		}
		...
		public override bool IsCloakInvisible
		{
			...
			set
			{
				...
				if (value)
				{
					Out.SendMessage(LanguageMgr.GetTranslation(Client.Account.Language, "GamePlayer.IsCloakInvisible.Invisible"), ChatType.CT_System, ChatLocation.CL_SystemWindow);
				}
				else
				{
					Out.SendMessage(LanguageMgr.GetTranslation(Client.Account.Language, "GamePlayer.IsCloakInvisible.Visible"), ChatType.CT_System, ChatLocation.CL_SystemWindow);
				}
			}
		}
		...
		public override bool IsHelmInvisible
		{
			...
			set
			{
				...
				if (value)
				{
					Out.SendMessage(LanguageMgr.GetTranslation(Client.Account.Language, "GamePlayer.IsHelmInvisible.Invisible"), ChatType.CT_System, ChatLocation.CL_SystemWindow);
				}
				else
				{
					Out.SendMessage(LanguageMgr.GetTranslation(Client.Account.Language, "GamePlayer.IsHelmInvisible.Visible"), ChatType.CT_System, ChatLocation.CL_SystemWindow);
				}
			}
		}
		...
		public override void SwitchWeapon(eActiveWeaponSlot slot)
		{
			...
			{
				Out.SendMessage(LanguageMgr.GetTranslation(Client.Account.Language, "GamePlayer.SwitchWeapon.SpellCancelled"), ChatType.CT_SpellResisted, ChatLocation.CL_SystemWindow);
			...
			InventoryItem rightHandSlot = Inventory.GetItem(InventorySlot.RightHandWeapon);
			InventoryItem leftHandSlot = Inventory.GetItem(InventorySlot.LeftHandWeapon);
			InventoryItem twoHandSlot = Inventory.GetItem(InventorySlot.TwoHandWeapon);
			InventoryItem distanceSlot = Inventory.GetItem(InventorySlot.DistanceWeapon);
		...
		public override void StartAttack(GameObject attackTarget)
		{
			...
			if (!IsAlive)
			{
				Out.SendMessage(LanguageMgr.GetTranslation(Client.Account.Language, "GamePlayer.StartAttack.YouCantCombat"), ChatType.CT_YouHit, ChatLocation.CL_SystemWindow);
				return;
			}
			...
			{
				Out.SendMessage("You cannot enter combat in shade mode!", ChatType.CT_YouHit, ChatLocation.CL_SystemWindow);
				return;
			}

			if (IsStunned)
			{
				Out.SendMessage(LanguageMgr.GetTranslation(Client.Account.Language, "GamePlayer.StartAttack.CantAttackStunned"), ChatType.CT_YouHit, ChatLocation.CL_SystemWindow);
				return;
			}
			if (IsMezzed)
			{
				Out.SendMessage(LanguageMgr.GetTranslation(Client.Account.Language, "GamePlayer.StartAttack.CantAttackmesmerized"), ChatType.CT_YouHit, ChatLocation.CL_SystemWindow);
				return;
			}
			...
			{
				Out.SendMessage(LanguageMgr.GetTranslation(Client.Account.Language, "GamePlayer.StartAttack.YouMustWaitAgain", (vanishTimeout - CurrentRegion.Time + 1000) / 1000), ChatType.CT_YouHit, ChatLocation.CL_SystemWindow);
				return;
			}
			...
			{
				this.Out.SendMessage(LanguageMgr.GetTranslation(Client.Account.Language, "GamePlayer.StartAttack.YouMustWait", ((30000 - changeTime) / 1000).ToString()), ChatType.CT_YouHit, ChatLocation.CL_SystemWindow);
				return;
			}
			...
			if (IsDisarmed)
			{
				Out.SendMessage("You are disarmed and cannot attack!", ChatType.CT_YouHit, ChatLocation.CL_SystemWindow);
				return;
			}
			...
			{
				Out.SendMessage(LanguageMgr.GetTranslation(Client.Account.Language, "GamePlayer.StartAttack.CannotWithoutWeapon"), ChatType.CT_YouHit, ChatLocation.CL_SystemWindow);
				return;
			}
			if (AttackWeapon.Object_Type == (int)eObjectType.Instrument)
			{
				Out.SendMessage(LanguageMgr.GetTranslation(Client.Account.Language, "GamePlayer.StartAttack.CannotMelee"), ChatType.CT_YouHit, ChatLocation.CL_SystemWindow);
				return;
			}
			...
			if (ActiveWeaponSlot == eActiveWeaponSlot.Distance)
			{
				...
				{
					Out.SendMessage(LanguageMgr.GetTranslation(Client.Account.Language, "GamePlayer.StartAttack.SelectQuiver"), ChatType.CT_YouHit, ChatLocation.CL_SystemWindow);
					return;
				}
				// Check if selected ammo is compatible for ranged attack
				if (!CheckRangedAmmoCompatibilityWithActiveWeapon())
				{
					Out.SendMessage(LanguageMgr.GetTranslation(Client.Account.Language, "GamePlayer.StartAttack.CantUseQuiver"), ChatType.CT_YouHit, ChatLocation.CL_SystemWindow);
					return;
				}
				...
				{
					Out.SendMessage(LanguageMgr.GetTranslation(Client.Account.Language, "GamePlayer.StartAttack.TiredShot"), ChatType.CT_YouHit, ChatLocation.CL_SystemWindow);
					return;
				}

				if (Endurance < RANGE_ATTACK_ENDURANCE)
				{
					Out.SendMessage(LanguageMgr.GetTranslation(Client.Account.Language, "GamePlayer.StartAttack.TiredUse", AttackWeapon.Name), ChatType.CT_YouHit, ChatLocation.CL_SystemWindow);
					return;
				}
			...
			else
			{
				if (attackTarget == null)
					Out.SendMessage(LanguageMgr.GetTranslation(Client.Account.Language, "GamePlayer.StartAttack.CombatNoTarget"), ChatType.CT_YouHit, ChatLocation.CL_SystemWindow);
				else
                    if (attackTarget is GameNPC)
                    {
                        Out.SendMessage(LanguageMgr.GetTranslation(Client.Account.Language, "GamePlayer.StartAttack.CombatTarget",
                            attackTarget.GetName(0, false, Client.Account.Language, (attackTarget as GameNPC))), ChatType.CT_YouHit, ChatLocation.CL_SystemWindow);
                    }
                    else
                    {
                        Out.SendMessage(LanguageMgr.GetTranslation(Client.Account.Language, "GamePlayer.StartAttack.CombatTarget", attackTarget.GetName(0, false)), ChatType.CT_YouHit, ChatLocation.CL_SystemWindow);
                    }
			}
			...
			{
				StopCurrentSpellcast();
				Out.SendMessage(LanguageMgr.GetTranslation(Client.Account.Language, "GamePlayer.StartAttack.SpellCancelled"), ChatType.CT_SpellResisted, ChatLocation.CL_SystemWindow);
			}
			...
			else
			{
				...
				Out.SendMessage(LanguageMgr.GetTranslation(Client.Account.Language, "GamePlayer.StartAttack.YouPrepare", typeMsg, speed / 10, speed % 10, targetMsg), ChatType.CT_YouHit, ChatLocation.CL_SystemWindow);
			}
		}
		...
		public virtual void SwitchQuiver(eActiveQuiverSlot slot, bool forced)
		{
			...
			{
				InventorySlot updatedSlot = InventorySlot.Invalid;
				if ((slot & eActiveQuiverSlot.Fourth) > 0)
					updatedSlot = InventorySlot.FourthQuiver;
				else if ((slot & eActiveQuiverSlot.Third) > 0)
					updatedSlot = InventorySlot.ThirdQuiver;
				else if ((slot & eActiveQuiverSlot.Second) > 0)
					updatedSlot = InventorySlot.SecondQuiver;
				else if ((slot & eActiveQuiverSlot.First) > 0)
					updatedSlot = InventorySlot.FirstQuiver;
				...
				if (Inventory.GetItem(updatedSlot) != null && (ActiveQuiverSlot != slot || forced))
				{
					...
					Out.SendMessage(LanguageMgr.GetTranslation(Client.Account.Language, "GamePlayer.SwitchQuiver.ShootWith", Inventory.GetItem(updatedSlot).GetName(0, false)), ChatType.CT_System, ChatLocation.CL_SystemWindow);
				}
				else
				{
					ActiveQuiverSlot = eActiveQuiverSlot.None;
					Out.SendMessage(LanguageMgr.GetTranslation(Client.Account.Language, "GamePlayer.SwitchQuiver.NoMoreAmmo"), ChatType.CT_System, ChatLocation.CL_SystemWindow);
				}
			...
			{
				if (Inventory.GetItem(InventorySlot.FirstQuiver) != null)
					SwitchQuiver(eActiveQuiverSlot.First, true);
				else if (Inventory.GetItem(InventorySlot.SecondQuiver) != null)
					SwitchQuiver(eActiveQuiverSlot.Second, true);
				else if (Inventory.GetItem(InventorySlot.ThirdQuiver) != null)
					SwitchQuiver(eActiveQuiverSlot.Third, true);
				else if (Inventory.GetItem(InventorySlot.FourthQuiver) != null)
					SwitchQuiver(eActiveQuiverSlot.Fourth, true);
				else
				{
					ActiveQuiverSlot = eActiveQuiverSlot.None;
					Out.SendMessage(LanguageMgr.GetTranslation(Client.Account.Language, "GamePlayer.SwitchQuiver.NotUseQuiver"), ChatType.CT_System, ChatLocation.CL_SystemWindow);
				}
				Out.SendInventorySlotsUpdate(null);
			}
		}
					...
					case eObjectType.Fired:
						{
							if (ActiveQuiverSlot != eActiveQuiverSlot.None)
							{
								...
								{
										case eActiveQuiverSlot.Fourth: ammo = Inventory.GetItem(InventorySlot.FourthQuiver); break;
										case eActiveQuiverSlot.Third: ammo = Inventory.GetItem(InventorySlot.ThirdQuiver); break;
										case eActiveQuiverSlot.Second: ammo = Inventory.GetItem(InventorySlot.SecondQuiver); break;
										case eActiveQuiverSlot.First: ammo = Inventory.GetItem(InventorySlot.FirstQuiver); break;
								}
		...
		protected override InventoryItem RangeAttackAmmo
		{
			get
			{
				...
				if (weapon != null)
				{
					...
					{
							case (int)eObjectType.Thrown: ammo = Inventory.GetItem(InventorySlot.DistanceWeapon); break;
						...
						case (int)eObjectType.Fired:
							{
								switch (ActiveQuiverSlot)
								{
									...
									case eActiveQuiverSlot.None:
										...
										ammo = Inventory.GetFirstItemByObjectType((int)findType, InventorySlot.FirstBackpack, InventorySlot.LastBackpack);
		...
		protected override eCheckRangeAttackStateResult CheckRangeAttackState(GameObject target)
		{
			...
			{
				Out.SendMessage(LanguageMgr.GetTranslation(Client.Account.Language, "GamePlayer.Attack.TooTired"), ChatType.CT_System, ChatLocation.CL_SystemWindow);
			    ...
			    || RangedAttackState == eRangedAttackState.AimFireReload)
			{
				...
				{
					Out.SendMessage(LanguageMgr.GetTranslation(Client.Account.Language, "System.MustSelectTarget"), ChatType.CT_System, ChatLocation.CL_SystemWindow);
				}
				else if (!this.IsWithinRadius(target, AttackRange))
				{
					Out.SendMessage(LanguageMgr.GetTranslation(Client.Account.Language, "GamePlayer.Attack.TooFarAway", target.GetName(0, true)), ChatType.CT_System, ChatLocation.CL_SystemWindow);
				}
				else if (!TargetInView)  // TODO : wrong, must be checked with the target parameter and not with the targetObject
				{
					Out.SendMessage(LanguageMgr.GetTranslation(Client.Account.Language, "GamePlayer.Attack.CantSeeTarget"), ChatType.CT_System, ChatLocation.CL_SystemWindow);
				}
				else if (!IsObjectInFront(target, 90))
				{
					Out.SendMessage(LanguageMgr.GetTranslation(Client.Account.Language, "GamePlayer.Attack.NotInView", target.GetName(0, true)), ChatType.CT_System, ChatLocation.CL_SystemWindow);
				}
				else if (RangeAttackAmmo == null)
				{
					//another check for ammo just before firing
					Out.SendMessage(LanguageMgr.GetTranslation(Client.Account.Language, "GamePlayer.Attack.MustSelectQuiver"), ChatType.CT_YouHit, ChatLocation.CL_SystemWindow);
				}
				else if (!CheckRangedAmmoCompatibilityWithActiveWeapon())
				{
					Out.SendMessage(LanguageMgr.GetTranslation(Client.Account.Language, "GamePlayer.Attack.CantUseQuiver"), ChatType.CT_YouHit, ChatLocation.CL_SystemWindow);
				}
				else if (GameServer.ServerRules.IsAllowedToAttack(this, (GameLiving)target, false))
				{
					       ...
					       ))
					{
						...
						// TODO: more checks?
						Out.SendMessage(LanguageMgr.GetTranslation(Client.Account.Language, "GamePlayer.Attack.CantCritical"), ChatType.CT_System, ChatLocation.CL_SystemWindow);
			...
			{
				Out.SendMessage(LanguageMgr.GetTranslation(Client.Account.Language, "GamePlayer.Attack.ReadyToFire"), ChatType.CT_System, ChatLocation.CL_SystemWindow);
				RangedAttackState = eRangedAttackState.ReadyToFire;
				return eCheckRangeAttackStateResult.Hold;
			}
		...
		protected override void SendAttackingCombatMessages(AttackData ad)
		{
            ...
            if (ad.Target is GameNPC)
            {
                switch (ad.AttackResult)
                {
                    case eAttackResult.TargetNotVisible: Out.SendMessage(LanguageMgr.GetTranslation(Client.Account.Language, "GamePlayer.Attack.NotInView",
                        ad.Target.GetName(0, true, Client.Account.Language, (ad.Target as GameNPC))), ChatType.CT_YouHit, ChatLocation.CL_SystemWindow); break;
                    ...
                    case eAttackResult.Evaded: Out.SendMessage(LanguageMgr.GetTranslation(Client.Account.Language, "GamePlayer.Attack.Evaded",
                        ad.Target.GetName(0, true, Client.Account.Language, (ad.Target as GameNPC))), ChatType.CT_YouHit, ChatLocation.CL_SystemWindow); break;
                    case eAttackResult.NoTarget: Out.SendMessage(LanguageMgr.GetTranslation(Client.Account.Language, "GamePlayer.Attack.NeedTarget"), ChatType.CT_YouHit, ChatLocation.CL_SystemWindow); break;
                    case eAttackResult.NoValidTarget: Out.SendMessage(LanguageMgr.GetTranslation(Client.Account.Language, "GamePlayer.Attack.CantBeAttacked"), ChatType.CT_YouHit, ChatLocation.CL_SystemWindow); break;
                    case eAttackResult.Missed: Out.SendMessage(LanguageMgr.GetTranslation(Client.Account.Language, "GamePlayer.Attack.Miss"), ChatType.CT_YouHit, ChatLocation.CL_SystemWindow); break;
                    case eAttackResult.Fumbled: Out.SendMessage(LanguageMgr.GetTranslation(Client.Account.Language, "GamePlayer.Attack.Fumble"), ChatType.CT_YouHit, ChatLocation.CL_SystemWindow); break;
                    case eAttackResult.HitStyle:
                    case eAttackResult.HitUnstyled:
                        string modmessage = "";
                        ...
                        {
                            Out.SendMessage(LanguageMgr.GetTranslation(Client.Account.Language, "GamePlayer.Attack.Intercepted", ad.Target.GetName(0, true), target.GetName(0, false)), ChatType.CT_YouHit, ChatLocation.CL_SystemWindow);
                            Out.SendMessage(LanguageMgr.GetTranslation(Client.Account.Language, "GamePlayer.Attack.InterceptedHit", attackTypeMsg, target.GetName(0, false), hitWeapon, ad.Target.GetName(0, false), ad.Damage, modmessage), ChatType.CT_YouHit, ChatLocation.CL_SystemWindow);
                        }
                        else
                            Out.SendMessage(LanguageMgr.GetTranslation(Client.Account.Language, "GamePlayer.Attack.InterceptHit", attackTypeMsg,
                                ad.Target.GetName(0, false, Client.Account.Language, (ad.Target as GameNPC)), hitWeapon, ad.Damage, modmessage), ChatType.CT_YouHit, ChatLocation.CL_SystemWindow);

                        // critical hit
                        if (ad.CriticalDamage > 0)
                            Out.SendMessage(LanguageMgr.GetTranslation(Client.Account.Language, "GamePlayer.Attack.Critical",
                                ad.Target.GetName(0, false, Client.Account.Language, (ad.Target as GameNPC)), ad.CriticalDamage), ChatType.CT_YouHit, ChatLocation.CL_SystemWindow);
                        break;
                }
            }
            else
            {
                switch (ad.AttackResult)
                {
                    case eAttackResult.TargetNotVisible: Out.SendMessage(LanguageMgr.GetTranslation(Client.Account.Language, "GamePlayer.Attack.NotInView", ad.Target.GetName(0, true)), ChatType.CT_YouHit, ChatLocation.CL_SystemWindow); break;
                    case eAttackResult.OutOfRange: Out.SendMessage(LanguageMgr.GetTranslation(Client.Account.Language, "GamePlayer.Attack.TooFarAway", ad.Target.GetName(0, true)), ChatType.CT_YouHit, ChatLocation.CL_SystemWindow); break;
                    case eAttackResult.TargetDead: Out.SendMessage(LanguageMgr.GetTranslation(Client.Account.Language, "GamePlayer.Attack.AlreadyDead", ad.Target.GetName(0, true)), ChatType.CT_YouHit, ChatLocation.CL_SystemWindow); break;
                    case eAttackResult.Blocked: Out.SendMessage(LanguageMgr.GetTranslation(Client.Account.Language, "GamePlayer.Attack.Blocked", ad.Target.GetName(0, true)), ChatType.CT_YouHit, ChatLocation.CL_SystemWindow); break;
                    case eAttackResult.Parried: Out.SendMessage(LanguageMgr.GetTranslation(Client.Account.Language, "GamePlayer.Attack.Parried", ad.Target.GetName(0, true)), ChatType.CT_YouHit, ChatLocation.CL_SystemWindow); break;
                    case eAttackResult.Evaded: Out.SendMessage(LanguageMgr.GetTranslation(Client.Account.Language, "GamePlayer.Attack.Evaded", ad.Target.GetName(0, true)), ChatType.CT_YouHit, ChatLocation.CL_SystemWindow); break;
                    case eAttackResult.NoTarget: Out.SendMessage(LanguageMgr.GetTranslation(Client.Account.Language, "GamePlayer.Attack.NeedTarget"), ChatType.CT_YouHit, ChatLocation.CL_SystemWindow); break;
                    case eAttackResult.NoValidTarget: Out.SendMessage(LanguageMgr.GetTranslation(Client.Account.Language, "GamePlayer.Attack.CantBeAttacked"), ChatType.CT_YouHit, ChatLocation.CL_SystemWindow); break;
                    case eAttackResult.Missed: Out.SendMessage(LanguageMgr.GetTranslation(Client.Account.Language, "GamePlayer.Attack.Miss"), ChatType.CT_YouHit, ChatLocation.CL_SystemWindow); break;
                    case eAttackResult.Fumbled: Out.SendMessage(LanguageMgr.GetTranslation(Client.Account.Language, "GamePlayer.Attack.Fumble"), ChatType.CT_YouHit, ChatLocation.CL_SystemWindow); break;
                    ...
                    case eAttackResult.HitUnstyled:
                        ...
                        if (target != null && target != ad.Target)
                        {
                            ...
                            Out.SendMessage(LanguageMgr.GetTranslation(Client.Account.Language, "GamePlayer.Attack.InterceptHit", attackTypeMsg, ad.Target.GetName(0, false), hitWeapon, ad.Damage, modmessage), ChatType.CT_YouHit, ChatLocation.CL_SystemWindow);

                        // critical hit
                        if (ad.CriticalDamage > 0)
                            Out.SendMessage(LanguageMgr.GetTranslation(Client.Account.Language, "GamePlayer.Attack.Critical", ad.Target.GetName(0, false), ad.CriticalDamage), ChatType.CT_YouHit, ChatLocation.CL_SystemWindow);
                        break;
                }
            }
		}
		...
		protected override AttackData MakeAttack(GameObject target, InventoryItem weapon, Style style, double effectiveness, int interruptDuration, bool dualWield)
		{
			if (IsCrafting)
			{
				Out.SendMessage("You interrupt your crafting.", ChatType.CT_System, ChatLocation.CL_SystemWindow);
				CraftTimer.Stop();
				CraftTimer = null;
				Out.SendCloseTimerWindow();
			}
				...
				case eAttackResult.HitUnstyled:
					{
						...
						if (IsStrafing && ad.Target is GamePlayer && Util.Chance(30))
						{
							...
							Out.SendMessage(LanguageMgr.GetTranslation(Client.Account.Language, "GamePlayer.Attack.StrafMiss"), ChatType.CT_YouHit, ChatLocation.CL_SystemWindow);
							break;
						}
						break;
					}
		...
		public override void OnAttackedByEnemy(AttackData ad)
		{
			...
			switch (ad.AttackResult)
			{
				...
				//case eAttackResult.Blocked : Out.SendMessage(ad.Attacker.GetName(0, true) + " attacks you and you block the blow!", ChatType.CT_Missed, ChatLocation.CL_SystemWindow); break;
				case eAttackResult.Parried:
                    if (ad.Attacker is GameNPC)
                        Out.SendMessage(LanguageMgr.GetTranslation(Client.Account.Language, "GamePlayer.Attack.Parry", ad.Attacker.GetName(0, true, Client.Account.Language, (ad.Attacker as GameNPC))), ChatType.CT_Missed, ChatLocation.CL_SystemWindow);
                    else
                        Out.SendMessage(LanguageMgr.GetTranslation(Client.Account.Language, "GamePlayer.Attack.Parry", ad.Attacker.GetName(0, true)), ChatType.CT_Missed, ChatLocation.CL_SystemWindow);
                    break;
				case eAttackResult.Evaded:
                    if (ad.Attacker is GameNPC)
                        Out.SendMessage(LanguageMgr.GetTranslation(Client.Account.Language, "GamePlayer.Attack.Evade", ad.Attacker.GetName(0, true, Client.Account.Language, (ad.Attacker as GameNPC))), ChatType.CT_Missed, ChatLocation.CL_SystemWindow);
                    else
                        Out.SendMessage(LanguageMgr.GetTranslation(Client.Account.Language, "GamePlayer.Attack.Evade", ad.Attacker.GetName(0, true)), ChatType.CT_Missed, ChatLocation.CL_SystemWindow);
                    break;
				case eAttackResult.Fumbled:
                    if (ad.Attacker is GameNPC)                    
                        Out.SendMessage(LanguageMgr.GetTranslation(Client.Account.Language, "GamePlayer.Attack.Fumbled", ad.Attacker.GetName(0, true, Client.Account.Language, (ad.Attacker as GameNPC))), ChatType.CT_Missed, ChatLocation.CL_SystemWindow);
                    else
                        Out.SendMessage(LanguageMgr.GetTranslation(Client.Account.Language, "GamePlayer.Attack.Fumbled", ad.Attacker.GetName(0, true)), ChatType.CT_Missed, ChatLocation.CL_SystemWindow);
                    break;
				case eAttackResult.Missed:
					if (ad.AttackType == AttackData.eAttackType.Spell)
						break;
                    if (ad.Attacker is GameNPC)
                        Out.SendMessage(LanguageMgr.GetTranslation(Client.Account.Language, "GamePlayer.Attack.Missed", ad.Attacker.GetName(0, true, Client.Account.Language, (ad.Attacker as GameNPC))), ChatType.CT_Missed, ChatLocation.CL_SystemWindow);
                    else
                        Out.SendMessage(LanguageMgr.GetTranslation(Client.Account.Language, "GamePlayer.Attack.Missed", ad.Attacker.GetName(0, true)), ChatType.CT_Missed, ChatLocation.CL_SystemWindow);
					break;
				case eAttackResult.HitStyle:
				case eAttackResult.HitUnstyled:
					{
                        ...
                        if (ad.Attacker is GameNPC)
                        {
                            if (hitLocName != null)
                                Out.SendMessage(LanguageMgr.GetTranslation(Client.Account.Language, "GamePlayer.Attack.HitsYour",
                                    ad.Attacker.GetName(0, true, Client.Account.Language, (ad.Attacker as GameNPC)), hitLocName, ad.Damage, modmessage), ChatType.CT_Damaged, ChatLocation.CL_SystemWindow);
                            else
                                Out.SendMessage(LanguageMgr.GetTranslation(Client.Account.Language, "GamePlayer.Attack.HitsYou",
                                    ad.Attacker.IsAlive ? ad.Attacker.GetName(0, true, Client.Account.Language, (ad.Attacker as GameNPC)) : "A dead enemy", ad.Damage, modmessage), ChatType.CT_Damaged, ChatLocation.CL_SystemWindow);

                            if (ad.CriticalDamage > 0)
                                Out.SendMessage(LanguageMgr.GetTranslation(Client.Account.Language, "GamePlayer.Attack.HitsYouCritical",
                                    ad.Attacker.GetName(0, true, Client.Account.Language, (ad.Attacker as GameNPC)), ad.CriticalDamage), ChatType.CT_Damaged, ChatLocation.CL_SystemWindow);
                        }
                        else
                        {
                            if (hitLocName != null)
                                Out.SendMessage(LanguageMgr.GetTranslation(Client.Account.Language, "GamePlayer.Attack.HitsYour", ad.Attacker.GetName(0, true), hitLocName, ad.Damage, modmessage), ChatType.CT_Damaged, ChatLocation.CL_SystemWindow);
                            else
                                Out.SendMessage(LanguageMgr.GetTranslation(Client.Account.Language, "GamePlayer.Attack.HitsYou", ad.Attacker.IsAlive ? ad.Attacker.GetName(0, true) : "A dead enemy", ad.Damage, modmessage), ChatType.CT_Damaged, ChatLocation.CL_SystemWindow);

                            if (ad.CriticalDamage > 0)
                                Out.SendMessage(LanguageMgr.GetTranslation(Client.Account.Language, "GamePlayer.Attack.HitsYouCritical", ad.Attacker.GetName(0, true), ad.CriticalDamage), ChatType.CT_Damaged, ChatLocation.CL_SystemWindow);
                        }
						...
						{
							InventoryItem item = Inventory.GetItem((InventorySlot)ad.ArmorHitLocation);
				...
				case eAttackResult.Blocked:
					{
						InventoryItem reactiveItem = Inventory.GetItem(InventorySlot.LeftHandWeapon);
			...
			if (IsCrafting)
			{
				Out.SendMessage("Your crafting is interrupted.", ChatType.CT_System, ChatLocation.CL_SystemWindow);
				CraftTimer.Stop();
				CraftTimer = null;
				Out.SendCloseTimerWindow();
			}
			...
			if (base.OnInterruptTick(attacker, attackType))
			{
				if (ActiveWeaponSlot == eActiveWeaponSlot.Distance)
				{
                    ...
                    if (attacker is GameNPC)
                        Out.SendMessage(LanguageMgr.GetTranslation(Client.Account.Language, "GamePlayer.Attack.Interrupted", attacker.GetName(0, true, Client.Account.Language, (attacker as GameNPC)), attackTypeMsg), ChatType.CT_YouHit, ChatLocation.CL_SystemWindow);
                    else
                        Out.SendMessage(LanguageMgr.GetTranslation(Client.Account.Language, "GamePlayer.Attack.Interrupted", attacker.GetName(0, true), attackTypeMsg), ChatType.CT_YouHit, ChatLocation.CL_SystemWindow);
				}
				return true;
			}
			return false;
		...
		public override double GetWeaponSkill(InventoryItem weapon)
		{
			...
			double classbase =
				(weapon.SlotPosition == (int)InventorySlot.DistanceWeapon
		...
		public override double GetArmorAF(eArmorSlot slot)
		{
			...
			InventoryItem item = Inventory.GetItem((InventorySlot)slot);
		...
		public override void Die(GameObject killer)
		{
			...
			if (m_releaseType == eReleaseType.Duel)
				messageType = ChatType.CT_Emote;
			else if (killer == null)
			{
				messageType = ChatType.CT_PlayerDied;
			}
			else
			{
				switch ((eRealm)killer.Realm)
				{
						case eRealm.Albion: messageType = ChatType.CT_KilledByAlb; break;
						case eRealm.Midgard: messageType = ChatType.CT_KilledByMid; break;
						case eRealm.Hibernia: messageType = ChatType.CT_KilledByHib; break;
						default: messageType = ChatType.CT_PlayerDied; break; // killed by mob
				}
			}

			if (killer is GamePlayer && killer != this)
			{
				((GamePlayer)killer).Out.SendMessage(LanguageMgr.GetTranslation(((GamePlayer)killer).Client, "GamePlayer.Die.YouKilled", GetName(0, false)), ChatType.CT_PlayerDied, ChatLocation.CL_SystemWindow);
			}
			...
			foreach (GamePlayer player in players)
			{
				...
				if (
					...
					if (player == this)
						player.Out.SendMessage(playerMessage, messageType, ChatLocation.CL_SystemWindow);
				else player.Out.SendMessage(publicMessage, messageType, ChatLocation.CL_SystemWindow);
			}
			...
			lock (m_LockObject)
			{
				...
				Out.SendMessage(LanguageMgr.GetTranslation(Client.Account.Language, "GamePlayer.Die.ReleaseToReturn"), ChatType.CT_YouDied, ChatLocation.CL_SystemWindow);
				...
				if (realmDeath)
				{
					Out.SendMessage(LanguageMgr.GetTranslation(Client.Account.Language, "GamePlayer.Die.DeadRVR"), ChatType.CT_YouDied, ChatLocation.CL_SystemWindow);
					xpLossPercent = 0;
				}
				else if (Level > 5) // under level 5 there is no penalty
				{
					Out.SendMessage(LanguageMgr.GetTranslation(Client.Account.Language, "GamePlayer.Die.LoseExperience"), ChatType.CT_YouDied, ChatLocation.CL_SystemWindow);
					// if this is the first death in level, you lose only half the penalty
					switch (DBCharacter.DeathCount)
					{
						case 0:
							Out.SendMessage(LanguageMgr.GetTranslation(Client.Account.Language, "GamePlayer.Die.DeathN1"), ChatType.CT_YouDied, ChatLocation.CL_SystemWindow);
							xpLossPercent /= 3;
							break;
						case 1:
							Out.SendMessage(LanguageMgr.GetTranslation(Client.Account.Language, "GamePlayer.Die.DeathN2"), ChatType.CT_YouDied, ChatLocation.CL_SystemWindow);
			...
			Message.SystemToOthers2(this, ChatType.CT_PlayerDied, "GamePlayer.Die.CorpseLies", GetName(0, true), GetPronoun(this.Client, 1, true));
			if (m_releaseType == eReleaseType.Duel)
			{
				Message.SystemToOthers(this, killer.Name + " wins the duel!", ChatType.CT_Emote);
			}
		...
		public void DuelStop()
		{
			...
			Out.SendMessage(LanguageMgr.GetTranslation(Client.Account.Language, "GamePlayer.DuelStop.DuelEnds"), ChatType.CT_Emote, ChatLocation.CL_SystemWindow);
			target.DuelStop();
		}
		...
		public override void CastSpell(Spell spell, SpellLine line)
		{
			...
			if (spell.SpellType == "StyleHandler" || spell.SpellType == "MLStyleHandler")
			{
				...
				else { Out.SendMessage("That style is not implemented!", ChatType.CT_SpellResisted, ChatLocation.CL_SystemWindow); }
			}
			...
			else
			{
				if (IsStunned)
				{
					Out.SendMessage(LanguageMgr.GetTranslation(Client.Account.Language, "GamePlayer.CastSpell.CantCastStunned"), ChatType.CT_SpellResisted, ChatLocation.CL_SystemWindow);
					return;
				}
				if (IsMezzed)
				{
					Out.SendMessage(LanguageMgr.GetTranslation(Client.Account.Language, "GamePlayer.CastSpell.CantCastMezzed"), ChatType.CT_SpellResisted, ChatLocation.CL_SystemWindow);
					return;
				}

				if (IsSilenced)
				{
					Out.SendMessage("You are fumbling for your words, and cannot cast!", ChatType.CT_Spell, ChatLocation.CL_SystemWindow);
					return;
				}
				...
				lock (m_spellQueueAccessMonitor)
				{
					if (m_runningSpellHandler != null)
					{
						...
						if (spell.CastTime > 0 && !(m_runningSpellHandler is ChamberSpellHandler) && spell.SpellType != "Chamber")
						{
							...
							{
								Out.SendMessage(LanguageMgr.GetTranslation(Client.Account.Language, "GamePlayer.CastSpell.AlreadyPlaySong"), ChatType.CT_SpellResisted, ChatLocation.CL_SystemWindow);
								return;
							}
							if (SpellQueue)
							{
								...
								{
									Out.SendMessage("You ready a " + spell.Name + " as a follow up!", ChatType.CT_YouHit, ChatLocation.CL_SystemWindow);
								}
								else
								{
									Out.SendMessage(LanguageMgr.GetTranslation(Client.Account.Language, "GamePlayer.CastSpell.AlreadyCastFollow"), ChatType.CT_SpellResisted, ChatLocation.CL_SystemWindow);
								}
							...
							else Out.SendMessage(LanguageMgr.GetTranslation(Client.Account.Language, "GamePlayer.CastSpell.AlreadyCastNoQueue"), ChatType.CT_SpellResisted, ChatLocation.CL_SystemWindow);
							return;
						}
						else if (m_runningSpellHandler is PrimerSpellHandler)
						{
							...
							{
								Out.SendMessage("Only a secondary spell can follow up the spell your are casting!", ChatType.CT_SpellResisted, ChatLocation.CL_SystemWindow);
							}
							else
							{
								if (SpellQueue && !(m_runningSpellHandler is ChamberSpellHandler))
								{
									...
									Out.SendMessage("You prepare a secondary spell!", ChatType.CT_SpellResisted, ChatLocation.CL_SystemWindow);
								}
								return;
							}
						}
						else if (m_runningSpellHandler is ChamberSpellHandler)
						{
							...
							if (spell.IsPrimary)
							{
								...
								{
									Out.SendMessage("This spell cannot be stored in this chamber.", ChatType.CT_SpellResisted, ChatLocation.CL_SystemWindow);
									return;
								}
								if (chamber.PrimarySpell == null)
								{
									...
									Out.SendMessage("You load " + spell.Name + " into your " + ((ChamberSpellHandler)m_runningSpellHandler).Spell.Name + ".", ChatType.CT_System, ChatLocation.CL_SystemWindow);
									Out.SendMessage("Select the second spell for your " + ((ChamberSpellHandler)m_runningSpellHandler).Spell.Name + ".", ChatType.CT_System, ChatLocation.CL_SystemWindow);
								}
								else
								{
									Out.SendMessage("This spell cannot be stored in this chamber.", ChatType.CT_SpellResisted, ChatLocation.CL_SystemWindow);
							...
							else if (spell.IsSecondary)
							{
								if (chamber.PrimarySpell != null)
								{
									...
									{
										Out.SendMessage("You have already chosen your spells for this chamber.", ChatType.CT_SpellResisted, ChatLocation.CL_SystemWindow);

									}
								}
								else
								{
									Out.SendMessage("You must store a primary spell first!", ChatType.CT_SpellResisted, ChatLocation.CL_SystemWindow);
						...
						{
							Out.SendMessage("You may not ready this spell as a followup!", ChatType.CT_SpellResisted, ChatLocation.CL_SystemWindow);
							return;
						}
					}
				}
					...
					else
					{
						if (spell.IsSecondary)
						{
							...
							if (m_runningSpellHandler == null && effect == null)
								Out.SendMessage("You cannot cast this spell directly!", ChatType.CT_SpellResisted, ChatLocation.CL_SystemWindow);
							else if (m_runningSpellHandler != null)
							{
								if (m_runningSpellHandler.Spell.IsPrimary)
								{
									lock (m_spellQueueAccessMonitor)
									{
										if (SpellQueue && !(m_runningSpellHandler is ChamberSpellHandler))
										{
											Out.SendMessage("You prepare this as a secondary spell!", ChatType.CT_SpellResisted, ChatLocation.CL_SystemWindow);
											m_nextSpell = spell;
				...
				{
					Out.SendMessage(spell.Name + " not implemented yet (" + spell.SpellType + ")", ChatType.CT_System, ChatLocation.CL_SystemWindow);
					return;
				}
			}
			return;
		...
		public void CastSpell(SpellCastingAbilityHandler ab)
		{
			...
			{
				Out.SendMessage(ab.Spell.Name + " not implemented yet (" + ab.Spell.SpellType + ")", ChatType.CT_System, ChatLocation.CL_SystemWindow);
			}
		}
				...
				lock (source)
				{
					if ((TradeWindow != null && source != TradeWindow.Partner) || (TradeWindow == null && !OpenTrade(source)))
					{
						if (TradeWindow != null)
						{
							...
							if (partner == null)
							{
								source.Out.SendMessage(Name + " is still selfcrafting.", ChatType.CT_System, ChatLocation.CL_SystemWindow);
							}
							else
							{
								source.Out.SendMessage(Name + " is still trading with " + partner.Name + ".", ChatType.CT_System, ChatLocation.CL_SystemWindow);
							}
						}
						else if (source.TradeWindow != null)
						{
							...
							{
								source.Out.SendMessage(LanguageMgr.GetTranslation(Client.Account.Language, "GamePlayer.ReceiveTradeItem.StillSelfcrafting"), ChatType.CT_System, ChatLocation.CL_SystemWindow);
							}
							else
							{
								source.Out.SendMessage("You are still trading with " + sourceTradePartner.Name + ".", ChatType.CT_System, ChatLocation.CL_SystemWindow);
							}
						}
						return false;
					}
					...
					{
						source.Out.SendMessage(LanguageMgr.GetTranslation(Client.Account.Language, "GamePlayer.ReceiveTradeItem.CantTrade"), ChatType.CT_System, ChatLocation.CL_SystemWindow);
						return false;
					}
		...
		{
			AddMoney(money, null, ChatType.CT_System, ChatLocation.CL_SystemWindow);
		}
		...
		{
			AddMoney(money, messageFormat, ChatType.CT_System, ChatLocation.CL_SystemWindow);
		}
		...
		public virtual void AddMoney(long money, string messageFormat, ChatType ct, ChatLocation cl)
		{
		...
		{
			return RemoveMoney(money, null, ChatType.CT_System, ChatLocation.CL_SystemWindow);
		}
		...
		{
			return RemoveMoney(money, messageFormat, ChatType.CT_System, ChatLocation.CL_SystemWindow);
		}
		...
		/// <param name="cl">message chat location</param>
		/// <returns>true if successfull, false if player doesn't have enough money</returns>
		public virtual bool RemoveMoney(long money, string messageFormat, ChatType ct, ChatLocation cl)
		{
		...
		public virtual void UseSlot(InventorySlot slot, eUseType type)
		{
		...
		public virtual void UseSlot(int slot, int type)
		{
			if (!IsAlive)
			{
				Out.SendMessage(LanguageMgr.GetTranslation(Client.Account.Language, "GamePlayer.UseSlot.CantFire"), ChatType.CT_System, ChatLocation.CL_SystemWindow);
				return;
			}

			lock (Inventory)
			{
				InventoryItem useItem = Inventory.GetItem((InventorySlot)slot);
				UseItem = useItem;
				...
				if (useItem == null)
				{
					...
					{
						Out.SendMessage("The quiver slot " + (slot - (Slot.FIRSTQUIVER) + 1) + " is empty!", ChatType.CT_System, ChatLocation.CL_SystemWindow);
					}
					else
					{
						// don't allow using empty slots
						Out.SendMessage(LanguageMgr.GetTranslation(Client.Account.Language, "GamePlayer.UseSlot.IllegalSourceObject", slot), ChatType.CT_System, ChatLocation.CL_SystemWindow);
					}
					return;
				}
				...
				if (useItem.Item_Type >= (int)InventorySlot.LeftFrontSaddleBag && useItem.Item_Type <= (int)InventorySlot.RightRearSaddleBag)
				{
				...
				{
					Out.SendMessage(LanguageMgr.GetTranslation(Client.Account.Language, "GamePlayer.UseSlot.AttemptToUse", useItem.GetName(0, false)), ChatType.CT_System, ChatLocation.CL_SystemWindow);
				}
					...
					case Slot.HORSE:
						if (type == 0)
						{
							...
							else
							{
								...
								{
									Out.SendMessage(LanguageMgr.GetTranslation(Client.Account.Language, "GamePlayer.UseSlot.SummonHorseLevel", useItem.Level), ChatType.CT_System, ChatLocation.CL_SystemWindow);
									return;
								}
								...
								{
									Out.SendMessage(LanguageMgr.GetTranslation(Client.Account.Language, reason), ChatType.CT_System, ChatLocation.CL_SystemWindow);
									return;
								}
								
								if (IsSummoningMount)
								{
									Out.SendMessage(LanguageMgr.GetTranslation(Client.Account.Language, "GamePlayer.UseSlot.StopCallingMount"), ChatType.CT_System, ChatLocation.CL_SystemWindow);
									StopWhistleTimers();
									return;
								}
								...
								if (effect != null)
									effect.Cancel(false);
								Out.SendMessage(LanguageMgr.GetTranslation(Client.Account.Language, "GamePlayer.UseSlot.WhistleMount"), ChatType.CT_Emote, ChatLocation.CL_SystemWindow);
						...
						if (!newAttack && RangedAttackState != eRangedAttackState.None)
						{
							...
							else if (RangedAttackState == eRangedAttackState.Aim)
							{
								if (!TargetInView)
								{
									...
									Out.SendMessage(LanguageMgr.GetTranslation(Client.Account.Language, "GamePlayer.UseSlot.CantSeeTarget"), ChatType.CT_System, ChatLocation.CL_SystemWindow);
								}
								else
								{
									...
									RangedAttackState = eRangedAttackState.AimFire;
									Out.SendMessage(LanguageMgr.GetTranslation(Client.Account.Language, "GamePlayer.UseSlot.AutoReleaseShot"), ChatType.CT_System, ChatLocation.CL_SystemWindow);
								}
							}
							else if (RangedAttackState == eRangedAttackState.AimFire)
							{
								RangedAttackState = eRangedAttackState.AimFireReload;
								Out.SendMessage(LanguageMgr.GetTranslation(Client.Account.Language, "GamePlayer.UseSlot.AutoReleaseShotReload"), ChatType.CT_System, ChatLocation.CL_SystemWindow);
							}
							else if (RangedAttackState == eRangedAttackState.AimFireReload)
							{
								RangedAttackState = eRangedAttackState.Aim;
								Out.SendMessage(LanguageMgr.GetTranslation(Client.Account.Language, "GamePlayer.UseSlot.NoAutoReleaseShotReload"), ChatType.CT_System, ChatLocation.CL_SystemWindow);
							}
						}
						break;
				...
				if (useItem.SpellID != 0 || useItem.SpellID1 != 0 || useItem.PoisonSpellID != 0) // don't return without firing events
				{
					if (IsSitting)
					{
						Out.SendMessage("You can't use an item while sitting!", ChatType.CT_System, ChatLocation.CL_SystemWindow);
						return;
					}
					...
					if (useItem.Object_Type == (int)eObjectType.Magical
					    && useItem.Item_Type == (int)InventorySlot.FirstBackpack
					    && useItem.SpellID > 0
					...
					{
						Out.SendMessage("The " + useItem.Name + " is out of charges.", ChatType.CT_System, ChatLocation.CL_SystemWindow);
						return;
					}
					else
					{
						if (useItem.Object_Type == (int)eObjectType.Poison)
						{
							...
							InventoryItem leftHand = Inventory.GetItem(InventorySlot.LeftHandWeapon);
						...
						else if (useItem.SpellID > 0 && useItem.Charges > 0 && useItem.Object_Type == (int)eObjectType.Magical && (useItem.Item_Type == (int)InventorySlot.FirstBackpack || useItem.Item_Type == 41))
						{
							...
							if (spell != null)
							{
								...
								{
									Out.SendMessage(LanguageMgr.GetTranslation(Client.Account.Language, "GamePlayer.UseSlot.MustWaitBeforeUse", (nextPotionAvailTime - CurrentRegion.Time) / 1000), ChatType.CT_System, ChatLocation.CL_SystemWindow);
								}
								else
								{
									if (potionEffectLine != null)
									{
										...
										if (requiredLevel <= Level)
										{
											...
											{
												Out.SendMessage(LanguageMgr.GetTranslation(Client.Account.Language, "GamePlayer.UseSlot.CantUseInCombat"), ChatType.CT_System, ChatLocation.CL_SystemWindow);
											}
											//Eden
											else if ((IsStunned && !(Steed != null && Steed.Name == "Forceful Zephyr")) || IsMezzed || !IsAlive)
											{
												Out.SendMessage(LanguageMgr.GetTranslation(Client.Account.Language, "GamePlayer.UseSlot.CantUseState", useItem.GetName(0, false)), ChatType.CT_System, ChatLocation.CL_SystemWindow);
											}
											else if (spell.CastTime > 0 && IsCasting)
											{
												Out.SendMessage(LanguageMgr.GetTranslation(Client.Account.Language, "GamePlayer.UseSlot.CantUseCast", useItem.GetName(0, false)), ChatType.CT_System, ChatLocation.CL_SystemWindow);
											}
											else
											{
												...
												if (spellHandler != null)
												{
													...
													if (spell.Target.ToLower() == "enemy")
													{
														...
														if (!GameServer.ServerRules.IsAllowedToAttack(this, target, true))
														{
															...
															Out.SendMessage("You need a target for this ability!", ChatType.CT_System, ChatLocation.CL_SystemWindow);
															return;
														}
													}
													...
													if (useItem.Item_Type == (int)InventorySlot.FirstBackpack)
													{
														Emote(eEmote.Drink);
													...
													if (spellHandler.StartSpell(target, useItem))
													{
														...
														Out.SendMessage(LanguageMgr.GetTranslation(Client.Account.Language, "GamePlayer.UseSlot.Used", useItem.GetName(0, false)), ChatType.CT_System, ChatLocation.CL_SystemWindow);
												...
												{
													Out.SendMessage("Potion effect ID " + spell.ID + " is not implemented yet.", ChatType.CT_System, ChatLocation.CL_SystemWindow);
												}
											}
										}
										else
										{
											Out.SendMessage(LanguageMgr.GetTranslation(Client.Account.Language, "GamePlayer.UseSlot.NotEnouthPower"), ChatType.CT_System, ChatLocation.CL_SystemWindow);
										}
									}
									else
									{
										Out.SendMessage("Potion effect line not found", ChatType.CT_System, ChatLocation.CL_SystemWindow);
									}
								}
							}
							else
							{
								Out.SendMessage("Potion effect spell ID " + useItem.SpellID + " not found.", ChatType.CT_System, ChatLocation.CL_SystemWindow);
							}
						}
						else if (type > 0)
						{
							...
							{
								Out.SendMessage(LanguageMgr.GetTranslation(Client.Account.Language, "GamePlayer.UseSlot.CantUseFromBackpack"), ChatType.CT_System, ChatLocation.CL_SystemWindow);
							}
							else
							{
								...
								{
									Out.SendMessage("In your state you can't discharge any object.", ChatType.CT_System, ChatLocation.CL_SystemWindow);
								}
								else if (Client.Account.PrivLevel == 1 && (changeTime < delay || (CurrentRegion.Time - itemdelay) < itemreuse)) //2 minutes reuse timer
								{
									...
									{
										Out.SendMessage("You must wait " + (itemreuse - (CurrentRegion.Time - itemdelay)) / 1000 + " more second before discharge " + useItem.Name + "!", ChatType.CT_System, ChatLocation.CL_SystemWindow);
									}
									else
									{
										Out.SendMessage("You must wait " + (delay - changeTime) / 1000 + " more second before discharge another object!", ChatType.CT_System, ChatLocation.CL_SystemWindow);
									}
									return;
								}
								else
		...
		protected virtual void UseSaddleBag(InventoryItem useItem)
		{
			...
			switch ((InventorySlot)useItem.Item_Type)
			{
				case InventorySlot.LeftFrontSaddleBag:
					if (ChampionLevel >= 2)
					{
					...
					{
						Out.SendMessage("This saddlebag requires Champion Level 2!", ChatType.CT_SpellResisted, ChatLocation.CL_SystemWindow);
					}
					break;
				case InventorySlot.RightFrontSaddleBag:
					if (ChampionLevel >= 3)
					{
					...
					{
						Out.SendMessage("This saddlebag requires Champion Level 3!", ChatType.CT_SpellResisted, ChatLocation.CL_SystemWindow);
					}
					break;
				case InventorySlot.LeftRearSaddleBag:
					if (ChampionLevel >= 4)
					{
					...
					{
						Out.SendMessage("This saddlebag requires Champion Level 4!", ChatType.CT_SpellResisted, ChatLocation.CL_SystemWindow);
					}
					break;
				case InventorySlot.RightRearSaddleBag:
					if (ChampionLevel >= 5)
					{
					...
					{
						Out.SendMessage("This saddlebag requires Champion Level 5!", ChatType.CT_SpellResisted, ChatLocation.CL_SystemWindow);
					}
					break;
			}
			...
			if (bag != eHorseSaddleBag.None)
			{
				if ((DBCharacter.ActiveSaddleBags & (byte)bag) == 0)
				{
					if (Inventory.RemoveItem(useItem))
					{
						...
						Out.SendMessage("You've activated a saddlebag!", ChatType.CT_Important, ChatLocation.CL_SystemWindow);
						SaveIntoDatabase();
					}
					else
					{
						Out.SendMessage("An error occurred while trying to activate this saddlebag!", ChatType.CT_SpellResisted, ChatLocation.CL_SystemWindow);
					}
				}
				else
				{
					Out.SendMessage("You've already activated this saddlebag!", ChatType.CT_SpellResisted, ChatLocation.CL_SystemWindow);
				}
			}
		}
		...
		{
			if (Inventory.GetItem(InventorySlot.Horse) == null)
			{
				Out.SendMessage("You must be equipped with a horse.", ChatType.CT_System, ChatLocation.CL_SystemWindow);
				return false;
			}

			if (IsOnHorse == false)
			{
				Out.SendMessage("You must be on your horse to use this inventory.", ChatType.CT_System, ChatLocation.CL_SystemWindow);
				return false;
			}

			if (ChampionLevel == 0)
			{
				Out.SendMessage("You must be a champion to use this inventory.", ChatType.CT_System, ChatLocation.CL_SystemWindow);
				return false;
			}

			if (slot < (int)InventorySlot.FirstBagHorse || slot > (int)InventorySlot.LastBagHorse || (ChampionLevel >= 5 && ActiveSaddleBags == (byte)eHorseSaddleBag.All))
			{
				return true;
			}
			...
			try
			{
				...
				// ChatUtil.SendDebugMessage(this, string.Format("Check slot {0} if between {1} and {2}.  CL is {3}, ActiveSaddleBags is {4}, Required Bag is {5}", slot, (int)InventorySlot.FirstBagHorse, (int)InventorySlot.LastBagHorse, ChampionLevel, ActiveSaddleBags, saddleBagRequired));

				if ((ActiveSaddleBags & (byte)saddleBagRequired) > 0)
				{
					if (ChampionLevel >= 2 && slot < (int)InventorySlot.FirstBagHorse + NUM_SLOTS_PER_SADDLEBAG)
					{
						return true;
					}
					else if (ChampionLevel >= 3 && slot < (int)InventorySlot.FirstBagHorse + NUM_SLOTS_PER_SADDLEBAG * 2)
					{
						return true;
					}
					else if (ChampionLevel >= 4 && slot < (int)InventorySlot.FirstBagHorse + NUM_SLOTS_PER_SADDLEBAG * 3)
					{
						return true;
					}
				}
			...
			Out.SendMessage("You can't use this inventory.", ChatType.CT_System, ChatLocation.CL_SystemWindow);
			return false;
		}
		...
		protected virtual void UseItemCharge(InventoryItem useItem, int type)
		{
			...
			if (requiredLevel > Level)
			{
				Out.SendMessage("You are not powerful enough to use this item's spell.", ChatType.CT_System, ChatLocation.CL_SystemWindow);
				return;
			}
			...
			if (spell != null)
			{
				...
				{
					Out.SendMessage("Charge effect ID " + spell.ID + " is not implemented yet.", ChatType.CT_System, ChatLocation.CL_SystemWindow);
				}
			}
			else
			{
				if (type == 1)
				{
					Out.SendMessage("Charge effect ID " + useItem.SpellID + " not found.", ChatType.CT_System, ChatLocation.CL_SystemWindow);
				}
				else
				{
					Out.SendMessage("Charge effect ID " + useItem.SpellID1 + " not found.", ChatType.CT_System, ChatLocation.CL_SystemWindow);
				}
			}
		}
		...
		protected virtual bool UseMagicalItem(InventoryItem item, int type)
		{
			...
			{
				Out.SendMessage("You can't use anything in your state.", ChatType.CT_System, ChatLocation.CL_SystemWindow);
				return false;
			}

			if (m_runningSpellHandler != null)
			{
				Out.SendMessage("You are already casting a spell.", ChatType.CT_System, ChatLocation.CL_SystemWindow);
				return false;
			}
			...
			if (type == 1 || type == 0)
			{
				...
				if (spell != null)
				{
					...
					Out.SendMessage(String.Format("You use {0}.", item.GetName(0, false)), ChatType.CT_Skill, ChatLocation.CL_SystemWindow);
		...
		public bool ApplyPoison(InventoryItem poisonPotion, InventoryItem toItem)
		{
			...
			if (envenomSpec < 1)
			{
				Out.SendMessage(LanguageMgr.GetTranslation(Client.Account.Language, "GamePlayer.ApplyPoison.CantUsePoisons"), ChatType.CT_System, ChatLocation.CL_SystemWindow);
				return false;
			}
			if (!GlobalConstants.IsWeapon(toItem.Object_Type))
			{
				Out.SendMessage(LanguageMgr.GetTranslation(Client.Account.Language, "GamePlayer.ApplyPoison.PoisonsAppliedWeapons"), ChatType.CT_System, ChatLocation.CL_SystemWindow);
				return false;
			}
			if (!HasAbilityToUseItem(toItem.Template))
			{
				Out.SendMessage(LanguageMgr.GetTranslation(Client.Account.Language, "GamePlayer.ApplyPoison.CantPoisonWeapon"), ChatType.CT_System, ChatLocation.CL_SystemWindow);
				return false;
			}
			if (envenomSpec < poisonPotion.Level)
			{
				Out.SendMessage(LanguageMgr.GetTranslation(Client.Account.Language, "GamePlayer.ApplyPoison.CantUsePoison"), ChatType.CT_System, ChatLocation.CL_SystemWindow);
				return false;
			}
			if (InCombat)
			{
				Out.SendMessage(LanguageMgr.GetTranslation(Client.Account.Language, "GamePlayer.ApplyPoison.CantApplyRecentCombat"), ChatType.CT_System, ChatLocation.CL_SystemWindow);
				return false;
			}
			...
			if (toItem.PoisonSpellID != 0)
			{
				...
				if (canApply == false)
				{
					Out.SendMessage(string.Format("You can't poison your {0}!", toItem.GetName(0, false)), ChatType.CT_System, ChatLocation.CL_SystemWindow);
					return false;
				}
			}
			...
			Out.SendMessage(string.Format("You apply {0} to {1}.", poisonPotion.GetName(0, false), toItem.GetName(0, false)), ChatType.CT_System, ChatLocation.CL_SystemWindow);
			return true;
		}
		...
		public virtual bool PrivateMessageReceive(GamePlayer source, string str)
		{
			...
			ChatType type = ChatType.CT_Send;
			if (source.Client.Account.PrivLevel > 1)
				type = ChatType.CT_Staff;
			...
			if (afkmessage != null)
			{
				...
				else
				{
					source.Out.SendMessage(
						LanguageMgr.GetTranslation(source.Client, "GamePlayer.SendReceive.AfkMessage", Name, afkmessage), ChatType.CT_Say,
						ChatLocation.CL_ChatWindow);
				}
			}
		...
		public virtual bool SendPrivateMessage(GamePlayer target, string str)
		{
			...
			Out.SendMessage(LanguageMgr.GetTranslation(Client.Account.Language, "GamePlayer.Send.YouSendTo", str, target.Name), ChatType.CT_Send,
			                ChatLocation.CL_ChatWindow);
		...
		public override bool SayReceive(GameLiving source, string str)
		{
			...
			if (GameServer.ServerRules.IsAllowedToUnderstand(source, this) || Properties.ENABLE_DEBUG)
				Out.SendMessage(LanguageMgr.GetTranslation(Client.Account.Language, "GamePlayer.SayReceive.Says", source.GetName(0, false), str),
				                ChatType.CT_Say, ChatLocation.CL_ChatWindow);
			else
				Out.SendMessage(
		...
		public override bool Say(string str)
		{
			...
			if (!base.Say(str))
				return false;
			Out.SendMessage(LanguageMgr.GetTranslation(Client.Account.Language, "GamePlayer.Say.YouSay", str), ChatType.CT_Say,
			                ChatLocation.CL_ChatWindow);
			return true;
		}
		...
		public override bool YellReceive(GameLiving source, string str)
		{
			...
			if (IsIgnoring(source))
				return true;
			if (GameServer.ServerRules.IsAllowedToUnderstand(source, this))
				Out.SendMessage(source.GetName(0, false) + " yells, \"" + str + "\"", ChatType.CT_Say, ChatLocation.CL_ChatWindow);
			else
				Out.SendMessage(source.GetName(0, false) + " yells something in a language you don't understand.", ChatType.CT_Say,
				                ChatLocation.CL_ChatWindow);
			return true;
		}
		...
		public override bool Yell(string str)
		{
			...
			if (!base.Yell(str))
				return false;
			Out.SendMessage("You yell, \"" + str + "\"", ChatType.CT_Say, ChatLocation.CL_ChatWindow);
			return true;
		}
		...
		public override bool WhisperReceive(GameLiving source, string str)
		{
			...
			if (IsIgnoring(source))
				return true;
			if (GameServer.ServerRules.IsAllowedToUnderstand(source, this))
				Out.SendMessage(source.GetName(0, false) + " whispers to you, \"" + str + "\"", ChatType.CT_Say,
				                ChatLocation.CL_ChatWindow);
			else
		...
		public override bool Whisper(GameObject target, string str)
		{
			if (target == null)
			{
				Out.SendMessage(LanguageMgr.GetTranslation(Client.Account.Language, "GamePlayer.Whisper.SelectTarget"), ChatType.CT_System,
				                ChatLocation.CL_ChatWindow);
				return false;
			}
			...
			if (target is GamePlayer)
				Out.SendMessage("You whisper, \"" + str + "\" to " + target.GetName(0, false), ChatType.CT_Say, ChatLocation.CL_ChatWindow);
			return true;
		}
		...
		public override void MessageToSelf(string message, ChatType chatType)
		{
			Out.SendMessage(message, chatType, ChatLocation.CL_SystemWindow);
		}
		...
		/// <param name="message"></param>
		/// <param name="chatType"></param>
		public override void MessageFromControlled(string message, ChatType chatType)
		{
		...
		public virtual void MessageFromArea(GameObject source, string message, ChatType chatType, ChatLocation chatLocation)
		{
		...
		public void SwitchSeat(int slot)
		{
			...
			Out.SendMessage("You switch to seat " + slot + ".", ChatType.CT_System, ChatLocation.CL_SystemWindow);
		...
		public override bool AddToWorld()
		{
			...
			if (SpecPointsOk == false)
			{
                ...
                Out.SendMessage(LanguageMgr.GetTranslation(Client.Account.Language,"GamePlayer.AddToWorld.SpecsPointsIncorrect"), ChatType.CT_Important, ChatLocation.CL_SystemWindow);
                SpecPointsOk = true;
			}
		...
		protected int DrowningTimerCallback(RegionTimer callingTimer)
		{
			...
			if (this.Client.Account.PrivLevel == 1)
			{
				Out.SendMessage(LanguageMgr.GetTranslation(Client.Account.Language, "GamePlayer.DrowningTimerCallback.CannotBreath"), ChatType.CT_Damaged, ChatLocation.CL_SystemWindow);
				Out.SendMessage(LanguageMgr.GetTranslation(Client.Account.Language, "GamePlayer.DrowningTimerCallback.Take5%Damage"), ChatType.CT_Damaged, ChatLocation.CL_SystemWindow);
		...
		protected int LavaBurnTimerCallback(RegionTimer callingTimer)
		{
			...
			Out.SendMessage(LanguageMgr.GetTranslation(Client.Account.Language, "GamePlayer.LavaBurnTimerCallback.YourInLava"), ChatType.CT_Damaged, ChatLocation.CL_SystemWindow);
			Out.SendMessage(LanguageMgr.GetTranslation(Client.Account.Language, "GamePlayer.LavaBurnTimerCallback.Take34%Damage"), ChatType.CT_Damaged, ChatLocation.CL_SystemWindow);
			if (Client.Account.PrivLevel == 1)
			{
			...
			set
			{
				...
				if (value)
				{
					...
					if (AttackState && ActiveWeaponSlot == eActiveWeaponSlot.Distance)
					{
						...
						if (AttackWeapon.Object_Type == (int)eObjectType.Thrown)
							attackTypeMsg = "throw";
						Out.SendMessage("You move and interrupt your " + attackTypeMsg + "!", ChatType.CT_Important, ChatLocation.CL_SystemWindow);
						StopAttack();
					}
				}
			}
		...
		public virtual bool Sprint(bool state)
		{
			...
			if (state)
			{
				...
				if (Endurance <= 10)
				{
					Out.SendMessage(LanguageMgr.GetTranslation(Client.Account.Language, "GamePlayer.Sprint.TooFatigued"), ChatType.CT_System, ChatLocation.CL_SystemWindow);
					return false;
				}
				if (IsStealthed)
				{
					Out.SendMessage(LanguageMgr.GetTranslation(Client.Account.Language, "GamePlayer.Sprint.CantSprintHidden"), ChatType.CT_System, ChatLocation.CL_SystemWindow);
					return false;
				}
				if (!IsAlive)
				{
					Out.SendMessage(LanguageMgr.GetTranslation(Client.Account.Language, "GamePlayer.Sprint.CantSprintDead"), ChatType.CT_System, ChatLocation.CL_SystemWindow);
					return false;
				}
				...
				Out.SendUpdateMaxSpeed();
				Out.SendMessage(LanguageMgr.GetTranslation(Client.Account.Language, "GamePlayer.Sprint.PrepareSprint"), ChatType.CT_System, ChatLocation.CL_SystemWindow);
				return true;
			}
			else
			{
				...
				m_sprintEffect = null;
				Out.SendUpdateMaxSpeed();
				Out.SendMessage(LanguageMgr.GetTranslation(Client.Account.Language, "GamePlayer.Sprint.NoLongerReady"), ChatType.CT_System, ChatLocation.CL_SystemWindow);
				return false;
			}
		}
		...
		public virtual void OnPlayerMove()
		{
			...
			if (IsCastingRealmAbility)
			{
                ...
                Out.SendMessage(LanguageMgr.GetTranslation(Client.Account.Language, "SpellHandler.CasterMove"), ChatType.CT_Important, ChatLocation.CL_SystemWindow);
				RealmAbilityCastTimer.Stop();
				RealmAbilityCastTimer = null;
			}
			if (IsCrafting)
			{
				Out.SendMessage(LanguageMgr.GetTranslation(Client.Account.Language, "GamePlayer.OnPlayerMove.InterruptCrafting"), ChatType.CT_System, ChatLocation.CL_SystemWindow);
				CraftTimer.Stop();
				CraftTimer = null;
				Out.SendCloseTimerWindow();
			}
			if (IsSummoningMount)
			{
				Out.SendMessage(LanguageMgr.GetTranslation(Client.Account.Language, "GamePlayer.OnPlayerMove.CannotCallMount"), ChatType.CT_System, ChatLocation.CL_SystemWindow);
				StopWhistleTimers();
			}
			if (AttackState)
			{
		...
		public virtual void Sit(bool sit)
		{
			...
			if (IsSummoningMount)
			{
				Out.SendMessage(LanguageMgr.GetTranslation(Client.Account.Language, "GamePlayer.Sit.InterruptCallMount"), ChatType.CT_System, ChatLocation.CL_SystemWindow);
				StopWhistleTimers();
			}
			if (IsSitting == sit)
			{
				if (sit)
					Out.SendMessage(LanguageMgr.GetTranslation(Client.Account.Language, "GamePlayer.Sit.AlreadySitting"), ChatType.CT_System, ChatLocation.CL_SystemWindow);
				if (!sit)
					Out.SendMessage(LanguageMgr.GetTranslation(Client.Account.Language, "GamePlayer.Sit.NotSitting"), ChatType.CT_System, ChatLocation.CL_SystemWindow);
				return; // already done
			}

			if (!IsAlive)
			{
				Out.SendMessage(LanguageMgr.GetTranslation(Client.Account.Language, "GamePlayer.Sit.CantSitDead"), ChatType.CT_System, ChatLocation.CL_SystemWindow);
				return;
			}

			if (IsStunned)
			{
				Out.SendMessage(LanguageMgr.GetTranslation(Client.Account.Language, "GamePlayer.Sit.CantSitStunned"), ChatType.CT_System, ChatLocation.CL_SystemWindow);
				return;
			}

			if (IsMezzed)
			{
				Out.SendMessage(LanguageMgr.GetTranslation(Client.Account.Language, "GamePlayer.Sit.CantSitMezzed"), ChatType.CT_System, ChatLocation.CL_SystemWindow);
				return;
			}

			if (sit && CurrentSpeed > 0)
			{
				Out.SendMessage(LanguageMgr.GetTranslation(Client.Account.Language, "GamePlayer.Sit.MustStandingStill"), ChatType.CT_System, ChatLocation.CL_SystemWindow);
				return;
			}

			if (Steed != null || IsOnHorse)
			{
				Out.SendMessage(LanguageMgr.GetTranslation(Client.Account.Language, "GamePlayer.Sit.MustDismount"), ChatType.CT_System, ChatLocation.CL_SystemWindow);
				return;
			}

			if (sit)
			{
				Out.SendMessage(LanguageMgr.GetTranslation(Client.Account.Language, "GamePlayer.Sit.YouSitDown"), ChatType.CT_System, ChatLocation.CL_SystemWindow);
			}
			else
			{
				Out.SendMessage(LanguageMgr.GetTranslation(Client.Account.Language, "GamePlayer.Sit.YouStandUp"), ChatType.CT_System, ChatLocation.CL_SystemWindow);
			}
			...
			if (!sit)
			{
				...
				if (m_quitTimer != null)
				{
					...
					m_quitTimer = null;
					Stuck = false;
					Out.SendMessage(LanguageMgr.GetTranslation(Client.Account.Language, "GamePlayer.Sit.NoLongerWaitingQuit"), ChatType.CT_System, ChatLocation.CL_SystemWindow);
				}
		...
		public override void SetGroundTarget(int groundX, int groundY, int groundZ)
		{
			...
			Out.SendMessage(String.Format("You ground-target {0},{1},{2}", groundX, groundY, groundZ), ChatType.CT_System, ChatLocation.CL_SystemWindow);
			if (SiegeWeapon != null)
		...
		public void UpdateEncumberance()
		{
			if (Inventory.InventoryWeight > MaxEncumberance)
			{
				if (IsOverencumbered == false)
				{
					...
					Out.SendMessage(LanguageMgr.GetTranslation(Client.Account.Language, "GamePlayer.UpdateEncumberance.EncumberedMoveSlowly"), ChatType.CT_System, ChatLocation.CL_SystemWindow);
				}
				else
				{
					Out.SendMessage(LanguageMgr.GetTranslation(Client.Account.Language, "GamePlayer.UpdateEncumberance.Encumbered"), ChatType.CT_System, ChatLocation.CL_SystemWindow);
				}
				Out.SendUpdateMaxSpeed();
			}
		...
		protected virtual void OnItemEquipped(DOLEvent e, object sender, EventArgs arguments)
		{
			...
			if (item.Item_Type >= Slot.RIGHTHAND && item.Item_Type <= Slot.RANGED)
			{
				if (item.Hand == 1) // 2h
				{
					Out.SendMessage(string.Format(LanguageMgr.GetTranslation(Client.Account.Language, "GamePlayer.OnItemEquipped.WieldBothHands", item.GetName(0, false))), ChatType.CT_System, ChatLocation.CL_SystemWindow);
				}
				else if (item.SlotPosition == Slot.LEFTHAND)
				{
					Out.SendMessage(string.Format(LanguageMgr.GetTranslation(Client.Account.Language, "GamePlayer.OnItemEquipped.WieldLeftHand", item.GetName(0, false))), ChatType.CT_System, ChatLocation.CL_SystemWindow);
				}
				else
				{
					Out.SendMessage(string.Format(LanguageMgr.GetTranslation(Client.Account.Language, "GamePlayer.OnItemEquipped.WieldRightHand", item.GetName(0, false))), ChatType.CT_System, ChatLocation.CL_SystemWindow);
				}
			}
			...
			else if (item.Item_Type == (int)InventorySlot.HorseArmor)
			{
			...
			else if (item.Item_Type == (int)InventorySlot.HorseBarding)
			{
			...
			Out.SendMessage(string.Format(LanguageMgr.GetTranslation(Client.Account.Language, "GamePlayer.OnItemEquipped.Magic", item.GetName(0, false))), ChatType.CT_Skill, ChatLocation.CL_SystemWindow);

			if (item.Bonus1 != 0)
			{
				ItemBonus[item.Bonus1Type] += item.Bonus1;
				if (item.Bonus1Type < 20)
					Out.SendMessage(string.Format(LanguageMgr.GetTranslation(Client.Account.Language, "GamePlayer.OnItemEquipped.Increased", ItemBonusName(item.Bonus1Type))), ChatType.CT_Skill, ChatLocation.CL_SystemWindow);
			}
			if (item.Bonus2 != 0)
			{
				ItemBonus[item.Bonus2Type] += item.Bonus2;
				if (item.Bonus2Type < 20)
					Out.SendMessage(string.Format(LanguageMgr.GetTranslation(Client.Account.Language, "GamePlayer.OnItemEquipped.Increased", ItemBonusName(item.Bonus2Type))), ChatType.CT_Skill, ChatLocation.CL_SystemWindow);
			}
			if (item.Bonus3 != 0)
			{
				ItemBonus[item.Bonus3Type] += item.Bonus3;
				if (item.Bonus3Type < 20)
					Out.SendMessage(string.Format(LanguageMgr.GetTranslation(Client.Account.Language, "GamePlayer.OnItemEquipped.Increased", ItemBonusName(item.Bonus3Type))), ChatType.CT_Skill, ChatLocation.CL_SystemWindow);
			}
			if (item.Bonus4 != 0)
			{
				ItemBonus[item.Bonus4Type] += item.Bonus4;
				if (item.Bonus4Type < 20)
					Out.SendMessage(string.Format(LanguageMgr.GetTranslation(Client.Account.Language, "GamePlayer.OnItemEquipped.Increased", ItemBonusName(item.Bonus4Type))), ChatType.CT_Skill, ChatLocation.CL_SystemWindow);
			}
			if (item.Bonus5 != 0)
			{
				ItemBonus[item.Bonus5Type] += item.Bonus5;
				if (item.Bonus5Type < 20)
					Out.SendMessage(string.Format(LanguageMgr.GetTranslation(Client.Account.Language, "GamePlayer.OnItemEquipped.Increased", ItemBonusName(item.Bonus5Type))), ChatType.CT_Skill, ChatLocation.CL_SystemWindow);
			}
			if (item.Bonus6 != 0)
			{
				ItemBonus[item.Bonus6Type] += item.Bonus6;
				if (item.Bonus6Type < 20)
					Out.SendMessage(string.Format(LanguageMgr.GetTranslation(Client.Account.Language, "GamePlayer.OnItemEquipped.Increased", ItemBonusName(item.Bonus6Type))), ChatType.CT_Skill, ChatLocation.CL_SystemWindow);
			}
			if (item.Bonus7 != 0)
			{
				ItemBonus[item.Bonus7Type] += item.Bonus7;
				if (item.Bonus7Type < 20)
					Out.SendMessage(string.Format(LanguageMgr.GetTranslation(Client.Account.Language, "GamePlayer.OnItemEquipped.Increased", ItemBonusName(item.Bonus7Type))), ChatType.CT_Skill, ChatLocation.CL_SystemWindow);
			}
			if (item.Bonus8 != 0)
			{
				ItemBonus[item.Bonus8Type] += item.Bonus8;
				if (item.Bonus8Type < 20)
					Out.SendMessage(string.Format(LanguageMgr.GetTranslation(Client.Account.Language, "GamePlayer.OnItemEquipped.Increased", ItemBonusName(item.Bonus8Type))), ChatType.CT_Skill, ChatLocation.CL_SystemWindow);
			}
			if (item.Bonus9 != 0)
			{
				ItemBonus[item.Bonus9Type] += item.Bonus9;
				if (item.Bonus9Type < 20)
					Out.SendMessage(string.Format(LanguageMgr.GetTranslation(Client.Account.Language, "GamePlayer.OnItemEquipped.Increased", ItemBonusName(item.Bonus9Type))), ChatType.CT_Skill, ChatLocation.CL_SystemWindow);
			}
			if (item.Bonus10 != 0)
			{
				ItemBonus[item.Bonus10Type] += item.Bonus10;
				if (item.Bonus10Type < 20)
					Out.SendMessage(string.Format(LanguageMgr.GetTranslation(Client.Account.Language, "GamePlayer.OnItemEquipped.Increased", ItemBonusName(item.Bonus10Type))), ChatType.CT_Skill, ChatLocation.CL_SystemWindow);
			}
			if (item.ExtraBonus != 0)
			{
				ItemBonus[item.ExtraBonusType] += item.ExtraBonus;
				//if (item.ExtraBonusType < 20)
				//Out.SendMessage(string.Format(LanguageMgr.GetTranslation(Client.Account.Language, "GamePlayer.OnItemEquipped.Increased", ItemBonusName(item.ExtraBonusType))), ChatType.CT_Skill, ChatLocation.CL_SystemWindow);
			}
		...
		protected virtual void OnItemUnequipped(DOLEvent e, object sender, EventArgs arguments)
		{
			...
			if (item.Item_Type >= Slot.RIGHTHAND && item.Item_Type <= Slot.RANGED)
			{
				if (item.Hand == 1) // 2h
				{
					Out.SendMessage(string.Format(LanguageMgr.GetTranslation(Client.Account.Language, "GamePlayer.OnItemUnequipped.BothHandsFree", item.GetName(0, false))), ChatType.CT_Skill, ChatLocation.CL_SystemWindow);
				}
				else if (prevSlot == Slot.LEFTHAND)
				{
					Out.SendMessage(string.Format(LanguageMgr.GetTranslation(Client.Account.Language, "GamePlayer.OnItemUnequipped.LeftHandFree", item.GetName(0, false))), ChatType.CT_Skill, ChatLocation.CL_SystemWindow);
				}
				else
				{
					Out.SendMessage(string.Format(LanguageMgr.GetTranslation(Client.Account.Language, "GamePlayer.OnItemUnequipped.RightHandFree", item.GetName(0, false))), ChatType.CT_Skill, ChatLocation.CL_SystemWindow);
				}
			}

			if (prevSlot == Slot.MYTHICAL && item.Item_Type == (int)InventorySlot.Mythical && item is GameMythirian)
			{
			...
			if (item.Bonus1 != 0)
			{
				ItemBonus[item.Bonus1Type] -= item.Bonus1;
				if (item.Bonus1Type < 20)
					Out.SendMessage(string.Format(LanguageMgr.GetTranslation(Client.Account.Language, "GamePlayer.OnItemUnequipped.Decreased", ItemBonusName(item.Bonus1Type))), ChatType.CT_Skill, ChatLocation.CL_SystemWindow);
			}
			if (item.Bonus2 != 0)
			{
				ItemBonus[item.Bonus2Type] -= item.Bonus2;
				if (item.Bonus2Type < 20)
					Out.SendMessage(string.Format(LanguageMgr.GetTranslation(Client.Account.Language, "GamePlayer.OnItemUnequipped.Decreased", ItemBonusName(item.Bonus2Type))), ChatType.CT_Skill, ChatLocation.CL_SystemWindow);
			}
			if (item.Bonus3 != 0)
			{
				ItemBonus[item.Bonus3Type] -= item.Bonus3;
				if (item.Bonus3Type < 20)
					Out.SendMessage(string.Format(LanguageMgr.GetTranslation(Client.Account.Language, "GamePlayer.OnItemUnequipped.Decreased", ItemBonusName(item.Bonus3Type))), ChatType.CT_Skill, ChatLocation.CL_SystemWindow);
			}
			if (item.Bonus4 != 0)
			{
				ItemBonus[item.Bonus4Type] -= item.Bonus4;
				if (item.Bonus4Type < 20)
					Out.SendMessage(string.Format(LanguageMgr.GetTranslation(Client.Account.Language, "GamePlayer.OnItemUnequipped.Decreased", ItemBonusName(item.Bonus4Type))), ChatType.CT_Skill, ChatLocation.CL_SystemWindow);
			}
			if (item.Bonus5 != 0)
			{
				ItemBonus[item.Bonus5Type] -= item.Bonus5;
				if (item.Bonus5Type < 20)
					Out.SendMessage(string.Format(LanguageMgr.GetTranslation(Client.Account.Language, "GamePlayer.OnItemUnequipped.Decreased", ItemBonusName(item.Bonus5Type))), ChatType.CT_Skill, ChatLocation.CL_SystemWindow);
			}
			if (item.Bonus6 != 0)
			{
				ItemBonus[item.Bonus6Type] -= item.Bonus6;
				if (item.Bonus6Type < 20)
					Out.SendMessage(string.Format(LanguageMgr.GetTranslation(Client.Account.Language, "GamePlayer.OnItemUnequipped.Decreased", ItemBonusName(item.Bonus6Type))), ChatType.CT_Skill, ChatLocation.CL_SystemWindow);
			}
			if (item.Bonus7 != 0)
			{
				ItemBonus[item.Bonus7Type] -= item.Bonus7;
				if (item.Bonus7Type < 20)
					Out.SendMessage(string.Format(LanguageMgr.GetTranslation(Client.Account.Language, "GamePlayer.OnItemUnequipped.Decreased", ItemBonusName(item.Bonus7Type))), ChatType.CT_Skill, ChatLocation.CL_SystemWindow);
			}
			if (item.Bonus8 != 0)
			{
				ItemBonus[item.Bonus8Type] -= item.Bonus8;
				if (item.Bonus8Type < 20)
					Out.SendMessage(string.Format(LanguageMgr.GetTranslation(Client.Account.Language, "GamePlayer.OnItemUnequipped.Decreased", ItemBonusName(item.Bonus8Type))), ChatType.CT_Skill, ChatLocation.CL_SystemWindow);
			}
			if (item.Bonus9 != 0)
			{
				ItemBonus[item.Bonus9Type] -= item.Bonus9;
				if (item.Bonus9Type < 20)
					Out.SendMessage(string.Format(LanguageMgr.GetTranslation(Client.Account.Language, "GamePlayer.OnItemUnequipped.Decreased", ItemBonusName(item.Bonus9Type))), ChatType.CT_Skill, ChatLocation.CL_SystemWindow);
			}
			if (item.Bonus10 != 0)
			{
				ItemBonus[item.Bonus10Type] -= item.Bonus10;
				if (item.Bonus10Type < 20)
					Out.SendMessage(string.Format(LanguageMgr.GetTranslation(Client.Account.Language, "GamePlayer.OnItemUnequipped.Decreased", ItemBonusName(item.Bonus10Type))), ChatType.CT_Skill, ChatLocation.CL_SystemWindow);
			}
			if (item.ExtraBonus != 0)
			{
				ItemBonus[item.ExtraBonusType] -= item.ExtraBonus;
				//if (item.ExtraBonusType < 20)
				//Out.SendMessage(string.Format(LanguageMgr.GetTranslation(Client.Account.Language, "GamePlayer.OnItemUnequipped.Decreased", ItemBonusName(item.ExtraBonusType))), ChatType.CT_Skill, ChatLocation.CL_SystemWindow);
			}
		...
		public override bool ReceiveItem(GameLiving source, InventoryItem item)
		{
			...
			if (!Inventory.AddItem(InventorySlot.FirstEmptyBackpack, item))
				return false;
			InventoryLogging.LogInventoryAction(source, this, eInventoryActionType.Trade, item.Template, item.Count);

			if (source == null)
			{
				Out.SendMessage(String.Format(LanguageMgr.GetTranslation(Client.Account.Language, "GamePlayer.ReceiveItem.Receive", item.GetName(0, false))), ChatType.CT_Skill, ChatLocation.CL_SystemWindow);
			}
			else
			{
                if (source is GameNPC)
                    Out.SendMessage(String.Format(LanguageMgr.GetTranslation(Client.Account.Language, "GamePlayer.ReceiveItem.ReceiveFrom", item.GetName(0, false), source.GetName(0, false, Client.Account.Language, (source as GameNPC)))), ChatType.CT_Skill, ChatLocation.CL_SystemWindow);
                else
                    Out.SendMessage(String.Format(LanguageMgr.GetTranslation(Client.Account.Language, "GamePlayer.ReceiveItem.ReceiveFrom", item.GetName(0, false), source.GetName(0, false))), ChatType.CT_Skill, ChatLocation.CL_SystemWindow);
			}
		...
		public virtual bool DropItem(InventorySlot slot_pos)
		{
		...
		/// <returns>true if dropped</returns>
		public virtual bool DropItem(InventorySlot slot_pos, out WorldInventoryItem droppedItem)
		{
			droppedItem = null;
			if (slot_pos >= InventorySlot.FirstBackpack && slot_pos <= InventorySlot.LastBackpack)
			{
				lock (Inventory)
				{
					...
					if (!item.IsDropable)
					{
						Out.SendMessage(item.GetName(0, true) + " can not be dropped!", ChatType.CT_System, ChatLocation.CL_SystemWindow);
						return false;
					}
		...
		public virtual bool PickupObject(GameObject floorObject, bool checkRange)
		{
			if (floorObject == null)
			{
				Out.SendMessage(LanguageMgr.GetTranslation(Client.Account.Language, "GamePlayer.PickupObject.MustHaveTarget"), ChatType.CT_System, ChatLocation.CL_SystemWindow);
				return false;
			}
			...
			{
				Out.SendMessage(LanguageMgr.GetTranslation(Client.Account.Language, "GamePlayer.PickupObject.LootDoesntBelongYou"), ChatType.CT_System, ChatLocation.CL_SystemWindow);
				return false;
			}

			if ((floorObject is GameBoat == false) && !checkRange && !floorObject.IsWithinRadius(this, Properties.WORLD_PICKUP_DISTANCE, true))
			{
				Out.SendMessage(LanguageMgr.GetTranslation(Client.Account.Language, "GamePlayer.PickupObject.ObjectTooFarAway", floorObject.Name), ChatType.CT_System, ChatLocation.CL_SystemWindow);
				try
				{
			...
			if (floorObject is WorldInventoryItem)
			{
				...
				lock (floorItem)
				{
					...
					{
						Out.SendMessage(LanguageMgr.GetTranslation(Client.Account.Language, "GamePlayer.PickupObject.CantGetThat"), ChatType.CT_System, ChatLocation.CL_SystemWindow);
						return false;
					}
					if (floorItem.GetPickupTime > 0)
					{
						Out.SendMessage("You must wait another " + floorItem.GetPickupTime / 1000 + " seconds to pick up " + floorItem.Name + "!", ChatType.CT_System, ChatLocation.CL_SystemWindow);
						return false;
					}
					...
					if (mybattlegroup != null && mybattlegroup.GetBGLootType() == true && mybattlegroup.GetBGTreasurer() != null)
					{
						...
						if (theTreasurer.CanSeeObject(floorObject))
						{
							...
							if (floorItem.Item.IsStackable)
								good = theTreasurer.Inventory.AddTemplate(floorItem.Item, floorItem.Item.Count, InventorySlot.FirstBackpack, InventorySlot.LastBackpack);
							else
								good = theTreasurer.Inventory.AddItem(InventorySlot.FirstEmptyBackpack, floorItem.Item);

							if (!good)
							{
								theTreasurer.Out.SendMessage(LanguageMgr.GetTranslation(Client.Account.Language, "GamePlayer.PickupObject.BackpackFull"), ChatType.CT_System, ChatLocation.CL_SystemWindow);
								return false;
							}
							theTreasurer.Out.SendMessage(LanguageMgr.GetTranslation(Client.Account.Language, "GamePlayer.PickupObject.YouGet", floorItem.Item.GetName(1, false)), ChatType.CT_System, ChatLocation.CL_SystemWindow);
							Message.SystemToOthers(this, LanguageMgr.GetTranslation(Client.Account.Language, "GamePlayer.PickupObject.GroupMemberPicksUp", Name, floorItem.Item.GetName(1, false)), ChatType.CT_System);
						...
						{
							mybattlegroup.SendMessageToBattleGroupMembers(LanguageMgr.GetTranslation(Client.Account.Language, "GamePlayer.PickupObject.NoOneWantsThis", floorObject.Name), ChatType.CT_System, ChatLocation.CL_SystemWindow);
						}
					}
					else if (group != null && group.AutosplitLoot)
					{
						...
						foreach (GamePlayer ply in group.GetPlayersInTheGroup())
						{
							if (ply.IsAlive
							    ...
							    && (ply.Inventory.FindFirstEmptySlot(InventorySlot.FirstBackpack, InventorySlot.LastBackpack) != InventorySlot.Invalid))
							{
						...
						{
							Out.SendMessage(LanguageMgr.GetTranslation(Client.Account.Language, "GamePlayer.PickupObject.NoOneWantsThis", floorObject.Name), ChatType.CT_System, ChatLocation.CL_SystemWindow);
							return false;
						}
						...
						if (eligibleMember != null)
						{
							...
							if (floorItem.Item.IsStackable) // poison ID is lost here
								good = eligibleMember.Inventory.AddTemplate(floorItem.Item, floorItem.Item.Count, InventorySlot.FirstBackpack, InventorySlot.LastBackpack);
							else
								good = eligibleMember.Inventory.AddItem(InventorySlot.FirstEmptyBackpack, floorItem.Item);

							if (!good)
							{
								eligibleMember.Out.SendMessage(LanguageMgr.GetTranslation(Client.Account.Language, "GamePlayer.PickupObject.BackpackFull"), ChatType.CT_System, ChatLocation.CL_SystemWindow);
								return false;
							}
							Message.SystemToOthers(this, LanguageMgr.GetTranslation(Client.Account.Language, "GamePlayer.PickupObject.GroupMemberPicksUp", Name, floorItem.Item.GetName(1, false)), ChatType.CT_System);
							group.SendMessageToGroupMembers(LanguageMgr.GetTranslation(Client.Account.Language, "GamePlayer.PickupObject.Autosplit", floorItem.Item.GetName(1, true), eligibleMember.Name), ChatType.CT_System, ChatLocation.CL_SystemWindow);
							InventoryLogging.LogInventoryAction("(ground)", this, eInventoryActionType.Loot, floorItem.Item.Template, floorItem.Item.IsStackable ? floorItem.Item.Count : 1);
						}
					}
					else
					{
						bool good = false;
						if (floorItem.Item.IsStackable)
							good = Inventory.AddTemplate(GameInventoryItem.Create<InventoryItem>(floorItem.Item), floorItem.Item.Count, InventorySlot.FirstBackpack, InventorySlot.LastBackpack);
						else
							good = Inventory.AddItem(InventorySlot.FirstEmptyBackpack, floorItem.Item);

						if (!good)
						{
							Out.SendMessage(LanguageMgr.GetTranslation(Client.Account.Language, "GamePlayer.PickupObject.BackpackFull"), ChatType.CT_System, ChatLocation.CL_SystemWindow);
							return false;
						}
						Out.SendMessage(LanguageMgr.GetTranslation(Client.Account.Language, "GamePlayer.PickupObject.YouGet", floorItem.Item.GetName(1, false)), ChatType.CT_System, ChatLocation.CL_SystemWindow);
						Message.SystemToOthers(this, LanguageMgr.GetTranslation(Client.Account.Language, "GamePlayer.PickupObject.GroupMemberPicksUp", Name, floorItem.Item.GetName(1, false)), ChatType.CT_System);
						InventoryLogging.LogInventoryAction("(ground)", this, eInventoryActionType.Loot, floorItem.Item.Template, floorItem.Item.IsStackable ? floorItem.Item.Count : 1);
					}
			...
			else if (floorObject is GameMoney)
			{
				...
				lock (moneyObject)
				{
					...
					if (Group != null && Group.AutosplitCoins)
					{
						...
						{
							Out.SendMessage(LanguageMgr.GetTranslation(Client.Account.Language, "GamePlayer.PickupObject.NoOneGroupWantsMoney"), ChatType.CT_System, ChatLocation.CL_SystemWindow);
							return false;
						}
			...
			else if (floorObject is GameBoat)
			{
				...
				{
					Out.SendMessage(LanguageMgr.GetTranslation(Client.Account.Language, "GamePlayer.PickupObject.TooFarFromBoat"), ChatType.CT_System, ChatLocation.CL_SystemWindow);
					return false;
				}
			...
			else if (floorObject is GameHouseVault && floorObject.CurrentHouse != null)
			{
				...
				if (houseVault.Detach(this))
				{
					...
					Inventory.AddItem(InventorySlot.FirstEmptyBackpack, GameInventoryItem.Create<ItemTemplate>(template));
		...
		public override void SaveIntoDatabase()
		{
			try
			{
				...
				Out.SendMessage(LanguageMgr.GetTranslation(Client.Account.Language, "GamePlayer.SaveIntoDatabase.CharacterSaved"), ChatType.CT_System, ChatLocation.CL_SystemWindow);
			}
			catch (Exception e)
			{
				if (log.IsErrorEnabled)
		...
		public virtual void Stealth(bool goStealth)
		{
			...
			{
				Out.SendMessage("You can't stealth while crafting!", ChatType.CT_System, ChatLocation.CL_SystemWindow);
				return;
			}
			...
			if (goStealth)
			{
				...
				if (ObjectState == eObjectState.Active)
					Out.SendMessage(LanguageMgr.GetTranslation(Client.Account.Language, "GamePlayer.Stealth.NowHidden"), ChatType.CT_System, ChatLocation.CL_SystemWindow);
			...
			else
			{
				...
				if (ObjectState == eObjectState.Active)
					Out.SendMessage(LanguageMgr.GetTranslation(Client.Account.Language, "GamePlayer.Stealth.NoLongerHidden"), ChatType.CT_System, ChatLocation.CL_SystemWindow);
				...
				foreach (GameNPC npc in player.GetNPCsInRadius(1024))
				{
					...
					if (Util.ChanceDouble(chanceToUncover))
					{
						if (canSeePlayer)
						{
							...
							{
								player.Out.SendMessage(npc.GetName(0, true) + " uncovers you!", ChatType.CT_System, ChatLocation.CL_SystemWindow);
								player.Stealth(false);
								break;
							}
						}
		...
		public void UncoverLOSHandler(GamePlayer player, ushort response, ushort targetOID)
		{
			...
			{
				player.Out.SendMessage(target.GetName(0, true) + " uncovers you!", ChatType.CT_System, ChatLocation.CL_SystemWindow);
				player.Stealth(false);
			}
		}
		...
		public AbstractMission Mission
		{
			...
			set
			{
				...
				if (value != null) Out.SendMessage(m_mission.Description, ChatType.CT_System, ChatLocation.CL_SystemWindow);
			}
		}
		...
		public virtual bool GainCraftingSkill(eCraftingSkill skill, int count)
		{
			...
			lock (CraftingLock)
			{
				...
				if (craftingSkill != null && count >0)
				{
					...
					Out.SendMessage(LanguageMgr.GetTranslation(Client.Account.Language, "GamePlayer.GainCraftingSkill.GainSkill", craftingSkill.Name, m_craftingSkills[skill]), ChatType.CT_Important, ChatLocation.CL_SystemWindow);
			...
			lock (CraftingLock)
			{
				if (m_craftingSkills.ContainsKey(skill))
				{
					...
					if (craftingSkill != null)
					{
						...
						Out.SendMessage("You gain skill in " + craftingSkill.Name + "! (" + startValue + ").", ChatType.CT_Important, ChatLocation.CL_SystemWindow);
						return true;
					}
				}
			}
			...
			if (recipe != null)
			{
				...
				if (rawMaterials.Count > 0)
				{
					if (itemToCraft != null)
					{
						...
						{
							Out.SendMessage(LanguageMgr.GetTranslation(Client.Account.Language, "GamePlayer.CraftItem.DontHaveAbilityMake"), ChatType.CT_System, ChatLocation.CL_SystemWindow);
						}
					}
					else
					{
						Out.SendMessage("Crafted ItemTemplate (" + recipe.Id_nb + ") not implemented yet.", ChatType.CT_System, ChatLocation.CL_SystemWindow);
					}
				}
				else
				{
					Out.SendMessage("Craft recipe for (" + recipe.Id_nb + ") is missing raw materials!", ChatType.CT_System, ChatLocation.CL_SystemWindow);
				}
			}
			else
			{
				Out.SendMessage("CraftedItemID: (" + itemID + ") not implemented yet.", ChatType.CT_System, ChatLocation.CL_SystemWindow);
			}
		}
		...
		public bool OpenSelfCraft(InventoryItem item)
		{
			...
			lock (m_LockObject)
			{
				if (TradeWindow != null)
				{
					...
					if (sourceTradePartner == null)
					{
						Out.SendMessage(LanguageMgr.GetTranslation(Client.Account.Language, "GamePlayer.OpenSelfCraft.AlreadySelfCrafting"), ChatType.CT_System, ChatLocation.CL_SystemWindow);
					}
					else
					{
						Out.SendMessage("You are still trading with " + sourceTradePartner.Name + ".", ChatType.CT_System, ChatLocation.CL_SystemWindow);
					}
					return false;
				}
				...
				{
					Out.SendMessage(LanguageMgr.GetTranslation(Client.Account.Language, "GamePlayer.OpenSelfCraft.CanOnlyCraftBackpack"), ChatType.CT_System, ChatLocation.CL_SystemWindow);
					return false;
				}
		...
		public virtual void CommandNpcAttack()
		{
			...
			{
				Out.SendMessage(LanguageMgr.GetTranslation(Client.Account.Language, "GamePlayer.CommandNpcAttack.TooFarAwayForPet"), ChatType.CT_System, ChatLocation.CL_SystemWindow);
				return;
			}

			if (!TargetInView)
			{
				Out.SendMessage("You can't see your target!", ChatType.CT_SpellResisted, ChatLocation.CL_SystemWindow);
				return;
			}

			Out.SendMessage("You command " + npc.Body.GetName(0, false) + " to kill your target!", ChatType.CT_System, ChatLocation.CL_SystemWindow);
		...
		public virtual void CommandNpcFollow()
		{
			...
			Out.SendMessage("You command " + npc.Body.GetName(0, false) + " to follow you!", ChatType.CT_System, ChatLocation.CL_SystemWindow);
			npc.Follow(this);
		}
		...
		public virtual void CommandNpcStay()
		{
			...
			Out.SendMessage("You command " + npc.Body.GetName(0, false) + " to stay in this position!", ChatType.CT_System, ChatLocation.CL_SystemWindow);
			npc.Stay();
		}
		...
		public virtual void CommandNpcComeHere()
		{
			...
			Out.SendMessage("You command " + npc.Body.GetName(0, false) + " to come to you.", ChatType.CT_System, ChatLocation.CL_SystemWindow);
			npc.ComeHere();
		}
		...
		public virtual void CommandNpcGoTarget()
		{
			...
			if (target == null)
			{
				Out.SendMessage(LanguageMgr.GetTranslation(Client.Account.Language, "GamePlayer.CommandNpcGoTarget.MustSelectDestination"), ChatType.CT_System, ChatLocation.CL_SystemWindow);
				return;
			}
			Out.SendMessage("You command " + npc.Body.GetName(0, false) + " to go to your target.", ChatType.CT_System, ChatLocation.CL_SystemWindow);
			npc.Goto(target);
		}
		...
		public virtual void CommandNpcPassive()
		{
			...
			Out.SendMessage("You command " + npc.Body.GetName(0, false) + " to disengage from combat!", ChatType.CT_System, ChatLocation.CL_SystemWindow);
		...
		public virtual void CommandNpcAgressive()
		{
			...
			Out.SendMessage("You command " + npc.Body.GetName(0, false) + " to attack all enemies!", ChatType.CT_System, ChatLocation.CL_SystemWindow);
		...
		public virtual void CommandNpcDefensive()
		{
			...
			Out.SendMessage("You command " + npc.Body.GetName(0, false) + " to defend you!", ChatType.CT_System, ChatLocation.CL_SystemWindow);
			...
			set
			{
				...
				if (ObjectState == eObjectState.Active)
				{
					if (value == PlayerTitleMgr.ClearTitle)
						Out.SendMessage(LanguageMgr.GetTranslation(Client.Account.Language, "GamePlayer.CurrentTitle.TitleCleared"), ChatType.CT_System, ChatLocation.CL_SystemWindow);
					else
						Out.SendMessage("Your title has been set to " + value.GetDescription(this) + '.', ChatType.CT_System, ChatLocation.CL_SystemWindow);
				}
				UpdateCurrentTitle();
			}
		}
		...
		public virtual bool IsOnHorse
		{
			...
			set
			{
				...
				if (m_isOnHorse)
					Out.SendMessage(LanguageMgr.GetTranslation(Client.Account.Language, "GamePlayer.IsOnHorse.MountSteed"), ChatType.CT_System, ChatLocation.CL_SystemWindow);
				else
					Out.SendMessage(LanguageMgr.GetTranslation(Client.Account.Language, "GamePlayer.IsOnHorse.DismountSteed"), ChatType.CT_System, ChatLocation.CL_SystemWindow);
				Out.SendUpdateMaxSpeed();
			}
		}
		...
		public class ControlledHorse
		{
			...
			public byte ID
			{
				...
				{
					m_id = value;
					InventoryItem item = m_player.Inventory.GetItem(InventorySlot.Horse);
					if (item != null)
						m_level = item.Level;
					else
			...
			public byte Barding
			{
				get
				{
					InventoryItem barding = m_player.Inventory.GetItem(InventorySlot.HorseBarding);
					if (barding != null)
			...
			public byte Saddle
			{
				get
				{
					InventoryItem armor = m_player.Inventory.GetItem(InventorySlot.HorseArmor);
					if (armor != null)
		...
		public virtual void GainChampionExperience(long experience, eXPSource source)
		{
			...
			System.Globalization.NumberFormatInfo format = System.Globalization.NumberFormatInfo.InvariantInfo;
			Out.SendMessage("You get " + experience.ToString("N0", format) + " champion experience points.", ChatType.CT_Important, ChatLocation.CL_SystemWindow);
		...
		public virtual void ChampionLevelUp()
		{
			...
			Out.SendMessage("You have gained one champion level!", ChatType.CT_Important, ChatLocation.CL_SystemWindow);
			Out.SendUpdatePlayer();
			Out.SendUpdatePoints();
			UpdatePlayerStatus();
		}
		...
		public virtual double GetBlockChance()
		{
			...
			{
				lefthand = Inventory.GetItem(InventorySlot.LeftHandWeapon);
