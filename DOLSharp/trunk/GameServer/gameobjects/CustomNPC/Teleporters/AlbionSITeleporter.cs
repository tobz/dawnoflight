...
namespace DawnOfLight.GameServer.GameObjects.CustomNPC.Teleporters
{
	...
	public class AlbionSITeleporter : GameTeleporter
	{
		...
		public override bool AddToWorld()
		{
			...
			template.AddNPCEquipment(InventorySlot.Cloak, 57, 66);
			template.AddNPCEquipment(InventorySlot.TorsoArmor, 1005, 86);
			template.AddNPCEquipment(InventorySlot.LegsArmor, 140, 6);
			template.AddNPCEquipment(InventorySlot.ArmsArmor, 141, 6);
			template.AddNPCEquipment(InventorySlot.HandsArmor, 142, 6);
			template.AddNPCEquipment(InventorySlot.FeetArmor, 143, 6);
			template.AddNPCEquipment(InventorySlot.TwoHandWeapon, 1166);
