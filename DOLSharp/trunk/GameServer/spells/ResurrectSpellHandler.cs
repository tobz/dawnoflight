	...
	public class ResurrectSpellHandler : SpellHandler
	{
		...
		protected virtual void ResurrectLiving(GameLiving living)
		{
			...
			if (player != null)
			{
				...
				player.Out.SendMessage("You have been resurrected by " + m_caster.GetName(0, false) + "!", ChatType.CT_System, ChatLocation.CL_SystemWindow);
		...
		public override bool CheckBeginCast(GameLiving target)
		{
			...
			if (resurrectionCaster != null)
			{
				...
				MessageToCaster("Your target is already considering a resurrection!", ChatType.CT_SpellResisted);
				return false;
			}
